...
impl<'a> InnerString<'a> {
    pub fn from_outer(outer: &GodotString) -> Self {
        Self {
    ...
    pub fn casecmp_to(&self, to: GodotString) -> i64 {
        unsafe {
            let __variant_type = sys::GDEXTENSION_VARIANT_TYPE_STRING;
    ...
    pub fn num_scientific(number: f64) -> GodotString {
        unsafe {
            let __variant_type = sys::GDEXTENSION_VARIANT_TYPE_STRING;
            let __method_name = StringName::from("num_scientific");
            let __call_fn = sys::interface_fn!(variant_get_ptr_builtin_method)(
                __variant_type,
                __method_name.string_sys(),
                2710373411i64,
            ...
            let __call_fn = __call_fn.unwrap_unchecked();
            let __args = [<f64 as sys::GodotFfi>::sys_const(&number)];
            let __args_ptr = __args.as_ptr();
            <GodotString as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                __call_fn(
                    std::ptr::null_mut(),
    ...
    pub fn num(number: f64, decimals: i64) -> GodotString {
        unsafe {
            let __variant_type = sys::GDEXTENSION_VARIANT_TYPE_STRING;
            let __method_name = StringName::from("num");
            let __call_fn = sys::interface_fn!(variant_get_ptr_builtin_method)(
                __variant_type,
                __method_name.string_sys(),
                1555901022i64,
            ...
            let __call_fn = __call_fn.unwrap_unchecked();
            let __args = [
                <f64 as sys::GodotFfi>::sys_const(&number),
                <i64 as sys::GodotFfi>::sys_const(&decimals),
            ];
            let __args_ptr = __args.as_ptr();
            <GodotString as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                __call_fn(
    ...
    pub fn num_int64(number: i64, base: i64, capitalize_hex: bool) -> GodotString {
        unsafe {
            let __variant_type = sys::GDEXTENSION_VARIANT_TYPE_STRING;
            let __method_name = StringName::from("num_int64");
            let __call_fn = sys::interface_fn!(variant_get_ptr_builtin_method)(
                __variant_type,
                __method_name.string_sys(),
                2111271071i64,
            ...
            let __call_fn = __call_fn.unwrap_unchecked();
            let __args = [
                <i64 as sys::GodotFfi>::sys_const(&number),
                <i64 as sys::GodotFfi>::sys_const(&base),
                <bool as sys::GodotFfi>::sys_const(&capitalize_hex),
            ];
            let __args_ptr = __args.as_ptr();
            <GodotString as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                __call_fn(
    ...
    pub fn num_uint64(number: i64, base: i64, capitalize_hex: bool) -> GodotString {
        unsafe {
            let __variant_type = sys::GDEXTENSION_VARIANT_TYPE_STRING;
            let __method_name = StringName::from("num_uint64");
            let __call_fn = sys::interface_fn!(variant_get_ptr_builtin_method)(
                __variant_type,
                __method_name.string_sys(),
                2111271071i64,
    ...
    pub fn chr(char: i64) -> GodotString {
        unsafe {
            let __variant_type = sys::GDEXTENSION_VARIANT_TYPE_STRING;
            let __method_name = StringName::from("chr");
            let __call_fn = sys::interface_fn!(variant_get_ptr_builtin_method)(
                __variant_type,
                __method_name.string_sys(),
                897497541i64,
    ...
    pub fn humanize_size(size: i64) -> GodotString {
        unsafe {
            let __variant_type = sys::GDEXTENSION_VARIANT_TYPE_STRING;
            let __method_name = StringName::from("humanize_size");
            let __call_fn = sys::interface_fn!(variant_get_ptr_builtin_method)(
                __variant_type,
                __method_name.string_sys(),
                897497541i64,
