...
impl<'a> InnerVector3i<'a> {
    ...
    pub fn min_axis_index(&self) -> i64 {
        unsafe {
            let __variant_type = sys::GDEXTENSION_VARIANT_TYPE_VECTOR3I;
    ...
    pub fn clamp(&self, min: Vector3i, max: Vector3i) -> Vector3i {
        unsafe {
            ...
            let __call_fn = __call_fn.unwrap_unchecked();
            let __args = [
                <Vector3i as sys::GodotFfi>::sys_const(&min),
                <Vector3i as sys::GodotFfi>::sys_const(&max),
            ];
            let __args_ptr = __args.as_ptr();
            <Vector3i as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                __call_fn(self.sys_ptr, __args_ptr, return_ptr, __args.len() as i32);
    ...
    pub fn snapped(&self, step: Vector3i) -> Vector3i {
        unsafe {
            ...
            let __call_fn = __call_fn.unwrap_unchecked();
            let __args = [<Vector3i as sys::GodotFfi>::sys_const(&step)];
            let __args_ptr = __args.as_ptr();
            <Vector3i as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                __call_fn(self.sys_ptr, __args_ptr, return_ptr, __args.len() as i32);
            })
