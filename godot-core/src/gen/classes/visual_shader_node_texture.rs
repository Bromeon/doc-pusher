...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeTextureVirtual:
    ...
    impl VisualShaderNodeTexture {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeTexture");
                let __object_ptr =
        ...
        pub fn set_source(&mut self, value: visual_shader_node_texture::Source) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeTexture");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeTexture" , "set_source" , 905262939i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args =
                    [<visual_shader_node_texture::Source as sys::GodotFfi>::sys_const(&value)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        }
        pub fn get_source(&self) -> visual_shader_node_texture::Source {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeTexture");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeTexture" , "get_source" , 2896297444i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <visual_shader_node_texture::Source as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
        ...
        pub fn set_texture(&mut self, value: Gd<Texture2D>) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeTexture");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeTexture" , "set_texture" , 4051416890i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<Gd<Texture2D> as AsArg>::as_arg_ptr(&value)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        ...
        pub fn get_texture(&self) -> Option<Gd<Texture2D>> {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeTexture" , "get_texture" , 3635182373i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_texture_type(&mut self, value: visual_shader_node_texture::TextureType) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeTexture");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeTexture" , "set_texture_type" , 986314081i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <visual_shader_node_texture::TextureType as sys::GodotFfi>::sys_const(&value),
                ];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
        ...
        pub fn get_texture_type(&self) -> visual_shader_node_texture::TextureType {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeTexture");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeTexture" , "get_texture_type" , 3290430153i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <visual_shader_node_texture::TextureType as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
    ...
    impl crate::obj::GodotClass for VisualShaderNodeTexture {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeTexture";
    }
...
impl Source {
    ...
    pub const SOURCE_2D_TEXTURE: Self = Self { ord: 2 };
    pub const SOURCE_2D_NORMAL: Self = Self { ord: 3 };
    pub const SOURCE_DEPTH: Self = Self { ord: 4 };
    pub const SOURCE_PORT: Self = Self { ord: 5 };
    pub const SOURCE_3D_NORMAL: Self = Self { ord: 6 };
    pub const SOURCE_ROUGHNESS: Self = Self { ord: 7 };
    pub const SOURCE_MAX: Self = Self { ord: 8 };
}
...
impl TextureType {
    ...
    pub const TYPE_MAX: Self = Self { ord: 3 };
}
