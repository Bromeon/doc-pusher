...
pub(super) mod re_export {
    ...
    pub trait WebRtcPeerConnectionExtensionVirtual:
        crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api
    {
        ...
        fn get_connection_state(&self) -> web_rtc_peer_connection::ConnectionState {
            unimplemented!()
        }
        fn get_gathering_state(&self) -> web_rtc_peer_connection::GatheringState {
            unimplemented!()
        }
        fn get_signaling_state(&self) -> web_rtc_peer_connection::SignalingState {
            unimplemented!()
        }
        fn initialize(&mut self, p_config: Dictionary) -> global::Error {
            unimplemented!()
        }
        ...
        fn create_offer(&mut self) -> global::Error {
            unimplemented!()
        }
        ...
        fn add_ice_candidate(
            &mut self,
            p_sdp_mid_name: GodotString,
            p_sdp_mline_index: i64,
            p_sdp_name: GodotString,
        ) -> global::Error {
            unimplemented!()
        }
    ...
    impl WebRtcPeerConnectionExtension {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("WebRTCPeerConnectionExtension");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for WebRtcPeerConnectionExtension {
        ...
        const CLASS_NAME: &'static str = "WebRTCPeerConnectionExtension";
    }
