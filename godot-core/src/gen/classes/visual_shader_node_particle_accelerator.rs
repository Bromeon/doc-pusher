...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeParticleAcceleratorVirtual:
    ...
    impl VisualShaderNodeParticleAccelerator {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeParticleAccelerator");
                let __object_ptr =
        ...
        pub fn set_mode(&mut self, mode: visual_shader_node_particle_accelerator::Mode) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeParticleAccelerator");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeParticleAccelerator" , "set_mode" , 3457585749i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <visual_shader_node_particle_accelerator::Mode as sys::GodotFfi>::sys_const(
                        &mode,
                    ),
                ];
        ...
        pub fn get_mode(&self) -> visual_shader_node_particle_accelerator::Mode {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeParticleAccelerator");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeParticleAccelerator" , "get_mode" , 2660365633i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                < visual_shader_node_particle_accelerator :: Mode as sys :: GodotFfi > :: from_sys_init_default (| return_ptr | { __call_fn (__method_bind , self . object_ptr , __args_ptr , return_ptr) ; })
            }
        }
    }
    impl crate::obj::GodotClass for VisualShaderNodeParticleAccelerator {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeParticleAccelerator";
    }
    ...
    macro_rules! inherits_transitive_VisualShaderNodeParticleAccelerator {
        ($ Class : ident) => {
            impl ::godot::obj::Inherits<::godot::engine::VisualShaderNodeParticleAccelerator>
                for $Class
            {
            }
...
impl Mode {
    pub const MODE_LINEAR: Self = Self { ord: 0 };
    pub const MODE_RADIAL: Self = Self { ord: 1 };
    pub const MODE_TANGENTIAL: Self = Self { ord: 2 };
    pub const MODE_MAX: Self = Self { ord: 3 };
}
