...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeStepVirtual:
    ...
    impl VisualShaderNodeStep {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeStep");
                let __object_ptr =
        ...
        pub fn set_op_type(&mut self, op_type: visual_shader_node_step::OpType) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeStep");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeStep" , "set_op_type" , 715172489i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args =
                    [<visual_shader_node_step::OpType as sys::GodotFfi>::sys_const(&op_type)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        }
        pub fn get_op_type(&self) -> visual_shader_node_step::OpType {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeStep");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeStep" , "get_op_type" , 3274022781i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <visual_shader_node_step::OpType as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
    ...
    impl crate::obj::GodotClass for VisualShaderNodeStep {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeStep";
    }
