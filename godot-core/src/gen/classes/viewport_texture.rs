...
pub(super) mod re_export {
    ...
    pub trait ViewportTextureVirtual:
    ...
    impl ViewportTexture {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ViewportTexture");
                let __object_ptr =
        ...
        pub fn set_viewport_path_in_scene(&mut self, path: NodePath) {
            unsafe {
                let __class_name = StringName::from("ViewportTexture");
                let __method_name = StringName::from("set_viewport_path_in_scene");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1348162250i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ViewportTexture" , "set_viewport_path_in_scene" , 1348162250i64);
        ...
        pub fn get_viewport_path_in_scene(&self) -> NodePath {
            unsafe {
                let __class_name = StringName::from("ViewportTexture");
                let __method_name = StringName::from("get_viewport_path_in_scene");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    4075236667i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ViewportTexture" , "get_viewport_path_in_scene" , 4075236667i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for ViewportTexture {
        ...
        const CLASS_NAME: &'static str = "ViewportTexture";
    }
