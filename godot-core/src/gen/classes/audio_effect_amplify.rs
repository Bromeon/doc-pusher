...
pub(super) mod re_export {
    ...
    pub trait AudioEffectAmplifyVirtual:
    ...
    impl AudioEffectAmplify {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("AudioEffectAmplify");
                let __object_ptr =
        ...
        pub fn set_volume_db(&mut self, volume: f64) {
            unsafe {
                let __class_name = StringName::from("AudioEffectAmplify");
                let __method_name = StringName::from("set_volume_db");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    373806689i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AudioEffectAmplify" , "set_volume_db" , 373806689i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<f64 as sys::GodotFfi>::sys_const(&volume)];
        ...
        pub fn get_volume_db(&self) -> f64 {
            unsafe {
                let __class_name = StringName::from("AudioEffectAmplify");
                let __method_name = StringName::from("get_volume_db");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1740695150i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AudioEffectAmplify" , "get_volume_db" , 1740695150i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for AudioEffectAmplify {
        ...
        const CLASS_NAME: &'static str = "AudioEffectAmplify";
    }
