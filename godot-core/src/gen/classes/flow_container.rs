...
pub(super) mod re_export {
    ...
    pub trait FlowContainerVirtual:
    ...
    impl FlowContainer {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("FlowContainer");
                let __object_ptr =
        ...
        pub fn get_line_count(&self) -> i64 {
            unsafe {
                let __class_name = StringName::from("FlowContainer");
                let __method_name = StringName::from("get_line_count");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3905245786i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "FlowContainer" , "get_line_count" , 3905245786i64);
        ...
        pub fn set_alignment(&mut self, alignment: flow_container::AlignmentMode) {
            unsafe {
                let __class_name = StringName::from("FlowContainer");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "FlowContainer" , "set_alignment" , 575250951i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<flow_container::AlignmentMode as sys::GodotFfi>::sys_const(
                    &alignment,
                )];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn get_alignment(&self) -> flow_container::AlignmentMode {
            unsafe {
                let __class_name = StringName::from("FlowContainer");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "FlowContainer" , "get_alignment" , 3749743559i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <flow_container::AlignmentMode as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
        ...
        pub fn set_vertical(&mut self, vertical: bool) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "FlowContainer" , "set_vertical" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn is_vertical(&self) -> bool {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "FlowContainer" , "is_vertical" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for FlowContainer {
        ...
        const CLASS_NAME: &'static str = "FlowContainer";
    }
