...
pub(super) mod re_export {
    ...
    pub trait RectangleShape2DVirtual:
    ...
    impl RectangleShape2D {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("RectangleShape2D");
                let __object_ptr =
        ...
        pub fn set_size(&mut self, size: Vector2) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "RectangleShape2D" , "set_size" , 743155724i64);
        ...
        pub fn get_size(&self) -> Vector2 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "RectangleShape2D" , "get_size" , 3341600327i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for RectangleShape2D {
        ...
        const CLASS_NAME: &'static str = "RectangleShape2D";
    }
