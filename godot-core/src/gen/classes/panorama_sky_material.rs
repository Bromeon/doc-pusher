...
pub(super) mod re_export {
    ...
    pub trait PanoramaSkyMaterialVirtual:
    ...
    impl PanoramaSkyMaterial {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("PanoramaSkyMaterial");
                let __object_ptr =
        ...
        pub fn set_panorama(&mut self, texture: Gd<Texture2D>) {
            unsafe {
                let __class_name = StringName::from("PanoramaSkyMaterial");
                let __method_name = StringName::from("set_panorama");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    4051416890i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PanoramaSkyMaterial" , "set_panorama" , 4051416890i64);
        ...
        pub fn get_panorama(&self) -> Option<Gd<Texture2D>> {
            unsafe {
                let __class_name = StringName::from("PanoramaSkyMaterial");
                let __method_name = StringName::from("get_panorama");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3635182373i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PanoramaSkyMaterial" , "get_panorama" , 3635182373i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_filtering_enabled(&mut self, enabled: bool) {
            unsafe {
                let __class_name = StringName::from("PanoramaSkyMaterial");
                let __method_name = StringName::from("set_filtering_enabled");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PanoramaSkyMaterial" , "set_filtering_enabled" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn is_filtering_enabled(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("PanoramaSkyMaterial");
                let __method_name = StringName::from("is_filtering_enabled");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PanoramaSkyMaterial" , "is_filtering_enabled" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for PanoramaSkyMaterial {
        ...
        const CLASS_NAME: &'static str = "PanoramaSkyMaterial";
    }
