...
pub(super) mod re_export {
    ...
    impl ZipReader {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ZIPReader");
                let __object_ptr =
        ...
        pub fn open(&mut self, path: GodotString) -> global::Error {
            unsafe {
                let __class_name = StringName::from("ZIPReader");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ZIPReader" , "open" , 166001499i64);
        ...
        pub fn close(&mut self) -> global::Error {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ZIPReader" , "close" , 166280745i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <global::Error as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn get_files(&mut self) -> PackedStringArray {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ZIPReader" , "get_files" , 2981934095i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn read_file(&mut self, path: GodotString, case_sensitive: bool) -> PackedByteArray {
            unsafe {
                let __class_name = StringName::from("ZIPReader");
                let __method_name = StringName::from("read_file");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    156385007i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ZIPReader" , "read_file" , 156385007i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <GodotString as sys::GodotFfi>::sys_const(&path),
                    <bool as sys::GodotFfi>::sys_const(&case_sensitive),
                ];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for ZipReader {
        ...
        const CLASS_NAME: &'static str = "ZIPReader";
    }
