...
pub(super) mod re_export {
    ...
    pub trait ParallaxLayerVirtual:
    ...
    impl ParallaxLayer {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ParallaxLayer");
                let __object_ptr =
        ...
        pub fn set_motion_scale(&mut self, scale: Vector2) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ParallaxLayer" , "set_motion_scale" , 743155724i64);
        ...
        pub fn get_motion_scale(&self) -> Vector2 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ParallaxLayer" , "get_motion_scale" , 3341600327i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_motion_offset(&mut self, offset: Vector2) {
            unsafe {
                let __class_name = StringName::from("ParallaxLayer");
                let __method_name = StringName::from("set_motion_offset");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    743155724i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ParallaxLayer" , "set_motion_offset" , 743155724i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_motion_offset(&self) -> Vector2 {
            unsafe {
                let __class_name = StringName::from("ParallaxLayer");
                let __method_name = StringName::from("get_motion_offset");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3341600327i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ParallaxLayer" , "get_motion_offset" , 3341600327i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <Vector2 as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn set_mirroring(&mut self, mirror: Vector2) {
            unsafe {
                let __class_name = StringName::from("ParallaxLayer");
                let __method_name = StringName::from("set_mirroring");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    743155724i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ParallaxLayer" , "set_mirroring" , 743155724i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<Vector2 as sys::GodotFfi>::sys_const(&mirror)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        ...
        pub fn get_mirroring(&self) -> Vector2 {
            unsafe {
                let __class_name = StringName::from("ParallaxLayer");
                let __method_name = StringName::from("get_mirroring");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3341600327i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ParallaxLayer" , "get_mirroring" , 3341600327i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <Vector2 as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
    ...
    impl crate::obj::GodotClass for ParallaxLayer {
        ...
        const CLASS_NAME: &'static str = "ParallaxLayer";
    }
