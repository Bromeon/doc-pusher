...
pub(super) mod re_export {
    ...
    pub trait HeightMapShape3DVirtual:
    ...
    impl HeightMapShape3D {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("HeightMapShape3D");
                let __object_ptr =
        ...
        pub fn set_map_width(&mut self, width: i64) {
            unsafe {
                let __class_name = StringName::from("HeightMapShape3D");
                let __method_name = StringName::from("set_map_width");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1286410249i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "HeightMapShape3D" , "set_map_width" , 1286410249i64);
        ...
        pub fn get_map_width(&self) -> i64 {
            unsafe {
                let __class_name = StringName::from("HeightMapShape3D");
                let __method_name = StringName::from("get_map_width");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3905245786i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "HeightMapShape3D" , "get_map_width" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_map_depth(&mut self, height: i64) {
            unsafe {
                let __class_name = StringName::from("HeightMapShape3D");
                let __method_name = StringName::from("set_map_depth");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1286410249i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "HeightMapShape3D" , "set_map_depth" , 1286410249i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_map_depth(&self) -> i64 {
            unsafe {
                let __class_name = StringName::from("HeightMapShape3D");
                let __method_name = StringName::from("get_map_depth");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3905245786i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "HeightMapShape3D" , "get_map_depth" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <i64 as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn set_map_data(&mut self, data: PackedFloat32Array) {
            unsafe {
                let __class_name = StringName::from("HeightMapShape3D");
                let __method_name = StringName::from("set_map_data");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2899603908i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "HeightMapShape3D" , "set_map_data" , 2899603908i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<PackedFloat32Array as sys::GodotFfi>::sys_const(&data)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        ...
        pub fn get_map_data(&self) -> PackedFloat32Array {
            unsafe {
                let __class_name = StringName::from("HeightMapShape3D");
                let __method_name = StringName::from("get_map_data");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    675695659i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "HeightMapShape3D" , "get_map_data" , 675695659i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for HeightMapShape3D {
        ...
        const CLASS_NAME: &'static str = "HeightMapShape3D";
    }
