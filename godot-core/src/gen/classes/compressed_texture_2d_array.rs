...
pub(super) mod re_export {
    ...
    pub trait CompressedTexture2DArrayVirtual:
    ...
    impl CompressedTexture2DArray {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("CompressedTexture2DArray");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for CompressedTexture2DArray {
        ...
        const CLASS_NAME: &'static str = "CompressedTexture2DArray";
    }
