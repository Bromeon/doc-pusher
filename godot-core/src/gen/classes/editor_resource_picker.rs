...
pub(super) mod re_export {
    ...
    pub trait EditorResourcePickerVirtual:
        crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api
    {
        ...
        fn handle_menu_selected(&mut self, id: i64) -> bool {
            unimplemented!()
        }
    ...
    impl EditorResourcePicker {
        ...
        pub fn set_base_type(&mut self, base_type: GodotString) {
            unsafe {
                let __class_name = StringName::from("EditorResourcePicker");
                let __method_name = StringName::from("set_base_type");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    83702148i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "EditorResourcePicker" , "set_base_type" , 83702148i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<GodotString as sys::GodotFfi>::sys_const(&base_type)];
        ...
        pub fn get_base_type(&self) -> GodotString {
            unsafe {
                let __class_name = StringName::from("EditorResourcePicker");
                let __method_name = StringName::from("get_base_type");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    201670096i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "EditorResourcePicker" , "get_base_type" , 201670096i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn get_allowed_types(&self) -> PackedStringArray {
            unsafe {
                let __class_name = StringName::from("EditorResourcePicker");
                let __method_name = StringName::from("get_allowed_types");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1139954409i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "EditorResourcePicker" , "get_allowed_types" , 1139954409i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_edited_resource(&mut self, resource: Gd<Resource>) {
            unsafe {
                let __class_name = StringName::from("EditorResourcePicker");
                let __method_name = StringName::from("set_edited_resource");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    968641751i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "EditorResourcePicker" , "set_edited_resource" , 968641751i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_edited_resource(&mut self) -> Option<Gd<Resource>> {
            unsafe {
                let __class_name = StringName::from("EditorResourcePicker");
                let __method_name = StringName::from("get_edited_resource");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2674603643i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "EditorResourcePicker" , "get_edited_resource" , 2674603643i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_toggle_mode(&mut self, enable: bool) {
            unsafe {
                let __class_name = StringName::from("EditorResourcePicker");
                let __method_name = StringName::from("set_toggle_mode");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "EditorResourcePicker" , "set_toggle_mode" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn is_toggle_mode(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("EditorResourcePicker");
                let __method_name = StringName::from("is_toggle_mode");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "EditorResourcePicker" , "is_toggle_mode" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_toggle_pressed(&mut self, pressed: bool) {
            unsafe {
                let __class_name = StringName::from("EditorResourcePicker");
                let __method_name = StringName::from("set_toggle_pressed");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "EditorResourcePicker" , "set_toggle_pressed" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn set_editable(&mut self, enable: bool) {
            unsafe {
                let __class_name = StringName::from("EditorResourcePicker");
                let __method_name = StringName::from("set_editable");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "EditorResourcePicker" , "set_editable" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<bool as sys::GodotFfi>::sys_const(&enable)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
        ...
        pub fn is_editable(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("EditorResourcePicker");
                let __method_name = StringName::from("is_editable");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "EditorResourcePicker" , "is_editable" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <bool as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
    ...
    impl crate::obj::GodotClass for EditorResourcePicker {
        ...
        const CLASS_NAME: &'static str = "EditorResourcePicker";
    }
