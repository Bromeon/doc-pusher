...
pub(super) mod re_export {
    ...
    pub trait PlaceholderMaterialVirtual:
    ...
    impl PlaceholderMaterial {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("PlaceholderMaterial");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for PlaceholderMaterial {
        ...
        const CLASS_NAME: &'static str = "PlaceholderMaterial";
    }
