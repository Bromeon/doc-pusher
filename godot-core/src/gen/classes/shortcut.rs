...
pub(super) mod re_export {
    ...
    impl Shortcut {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("Shortcut");
                let __object_ptr =
        ...
        pub fn set_events(&mut self, events: VariantArray) {
            unsafe {
                let __class_name = StringName::from("Shortcut");
                let __method_name = StringName::from("set_events");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    381264803i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Shortcut" , "set_events" , 381264803i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<VariantArray as sys::GodotFfi>::sys_const(&events)];
        ...
        pub fn get_events(&self) -> VariantArray {
            unsafe {
                let __class_name = StringName::from("Shortcut");
                let __method_name = StringName::from("get_events");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3995934104i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Shortcut" , "get_events" , 3995934104i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn has_valid_event(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("Shortcut");
                let __method_name = StringName::from("has_valid_event");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Shortcut" , "has_valid_event" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn matches_event(&self, event: Gd<InputEvent>) -> bool {
            unsafe {
                let __class_name = StringName::from("Shortcut");
                let __method_name = StringName::from("matches_event");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3738334489i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Shortcut" , "matches_event" , 3738334489i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_as_text(&self) -> GodotString {
            unsafe {
                let __class_name = StringName::from("Shortcut");
                let __method_name = StringName::from("get_as_text");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    201670096i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Shortcut" , "get_as_text" , 201670096i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for Shortcut {
        ...
        const CLASS_NAME: &'static str = "Shortcut";
    }
