...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeBillboardVirtual:
    ...
    impl VisualShaderNodeBillboard {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeBillboard");
                let __object_ptr =
        ...
        pub fn set_billboard_type(
            &mut self,
            billboard_type: visual_shader_node_billboard::BillboardType,
        ) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeBillboard");
                let __method_name = StringName::from("set_billboard_type");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1227463289i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeBillboard" , "set_billboard_type" , 1227463289i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <visual_shader_node_billboard::BillboardType as sys::GodotFfi>::sys_const(
                        &billboard_type,
                    ),
                ];
        ...
        pub fn get_billboard_type(&self) -> visual_shader_node_billboard::BillboardType {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeBillboard");
                let __method_name = StringName::from("get_billboard_type");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3724188517i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeBillboard" , "get_billboard_type" , 3724188517i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                < visual_shader_node_billboard :: BillboardType as sys :: GodotFfi > :: from_sys_init_default (| return_ptr | { __call_fn (__method_bind , self . object_ptr , __args_ptr , return_ptr) ; })
            }
        }
        pub fn set_keep_scale_enabled(&mut self, enabled: bool) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeBillboard");
                let __method_name = StringName::from("set_keep_scale_enabled");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeBillboard" , "set_keep_scale_enabled" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn is_keep_scale_enabled(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeBillboard");
                let __method_name = StringName::from("is_keep_scale_enabled");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeBillboard" , "is_keep_scale_enabled" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for VisualShaderNodeBillboard {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeBillboard";
    }
...
impl BillboardType {
    pub const BILLBOARD_TYPE_DISABLED: Self = Self { ord: 0 };
    pub const BILLBOARD_TYPE_ENABLED: Self = Self { ord: 1 };
    pub const BILLBOARD_TYPE_FIXED_Y: Self = Self { ord: 2 };
    pub const BILLBOARD_TYPE_PARTICLES: Self = Self { ord: 3 };
    pub const BILLBOARD_TYPE_MAX: Self = Self { ord: 4 };
}
...
unsafe impl sys::GodotFfi for BillboardType {
