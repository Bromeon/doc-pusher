...
pub(super) mod re_export {
    ...
    pub trait AudioStreamPlaybackVirtual:
    ...
    impl AudioStreamPlayback {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("AudioStreamPlayback");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for AudioStreamPlayback {
        ...
        const CLASS_NAME: &'static str = "AudioStreamPlayback";
    }
