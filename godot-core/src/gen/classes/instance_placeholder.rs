...
pub(super) mod re_export {
    ...
    pub trait InstancePlaceholderVirtual:
    ...
    impl InstancePlaceholder {
        ...
        pub fn get_stored_values(&mut self, with_order: bool) -> Dictionary {
            unsafe {
                let __class_name = StringName::from("InstancePlaceholder");
                let __method_name = StringName::from("get_stored_values");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2230153369i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InstancePlaceholder" , "get_stored_values" , 2230153369i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<bool as sys::GodotFfi>::sys_const(&with_order)];
        ...
        pub fn create_instance(
            &mut self,
            replace: bool,
            custom_scene: Gd<PackedScene>,
        ) -> Option<Gd<Node>> {
            unsafe {
                let __class_name = StringName::from("InstancePlaceholder");
                let __method_name = StringName::from("create_instance");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3794612210i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InstancePlaceholder" , "create_instance" , 3794612210i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <bool as sys::GodotFfi>::sys_const(&replace),
                    <Gd<PackedScene> as AsArg>::as_arg_ptr(&custom_scene),
                ];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn get_instance_path(&self) -> GodotString {
            unsafe {
                let __class_name = StringName::from("InstancePlaceholder");
                let __method_name = StringName::from("get_instance_path");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    201670096i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InstancePlaceholder" , "get_instance_path" , 201670096i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for InstancePlaceholder {
        ...
        const CLASS_NAME: &'static str = "InstancePlaceholder";
    }
