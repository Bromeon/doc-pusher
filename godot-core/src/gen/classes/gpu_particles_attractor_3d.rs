...
pub(super) mod re_export {
    ...
    pub trait GpuParticlesAttractor3DVirtual:
    ...
    impl GpuParticlesAttractor3D {
        ...
        pub fn set_cull_mask(&mut self, mask: i64) {
            unsafe {
                let __class_name = StringName::from("GPUParticlesAttractor3D");
                let __method_name = StringName::from("set_cull_mask");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1286410249i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GPUParticlesAttractor3D" , "set_cull_mask" , 1286410249i64);
        ...
        pub fn get_cull_mask(&self) -> i64 {
            unsafe {
                let __class_name = StringName::from("GPUParticlesAttractor3D");
                let __method_name = StringName::from("get_cull_mask");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3905245786i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GPUParticlesAttractor3D" , "get_cull_mask" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_strength(&mut self, strength: f64) {
            unsafe {
                let __class_name = StringName::from("GPUParticlesAttractor3D");
                let __method_name = StringName::from("set_strength");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    373806689i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GPUParticlesAttractor3D" , "set_strength" , 373806689i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_strength(&self) -> f64 {
            unsafe {
                let __class_name = StringName::from("GPUParticlesAttractor3D");
                let __method_name = StringName::from("get_strength");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1740695150i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GPUParticlesAttractor3D" , "get_strength" , 1740695150i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_attenuation(&mut self, attenuation: f64) {
            unsafe {
                let __class_name = StringName::from("GPUParticlesAttractor3D");
                let __method_name = StringName::from("set_attenuation");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    373806689i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GPUParticlesAttractor3D" , "set_attenuation" , 373806689i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<f64 as sys::GodotFfi>::sys_const(&attenuation)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        ...
        pub fn get_attenuation(&self) -> f64 {
            unsafe {
                let __class_name = StringName::from("GPUParticlesAttractor3D");
                let __method_name = StringName::from("get_attenuation");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1740695150i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GPUParticlesAttractor3D" , "get_attenuation" , 1740695150i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <f64 as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn set_directionality(&mut self, amount: f64) {
            unsafe {
                let __class_name = StringName::from("GPUParticlesAttractor3D");
                let __method_name = StringName::from("set_directionality");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    373806689i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GPUParticlesAttractor3D" , "set_directionality" , 373806689i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_directionality(&self) -> f64 {
            unsafe {
                let __class_name = StringName::from("GPUParticlesAttractor3D");
                let __method_name = StringName::from("get_directionality");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1740695150i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GPUParticlesAttractor3D" , "get_directionality" , 1740695150i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <f64 as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
    ...
    impl crate::obj::GodotClass for GpuParticlesAttractor3D {
        ...
        const CLASS_NAME: &'static str = "GPUParticlesAttractor3D";
    }
