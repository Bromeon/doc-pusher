...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeCustomVirtual:
        crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api
    {
        ...
        fn get_category(&self) -> GodotString {
            unimplemented!()
        }
        fn get_return_icon_type(&self) -> visual_shader_node::PortType {
            unimplemented!()
        }
        fn get_input_port_count(&self) -> i64 {
            unimplemented!()
        }
        fn get_input_port_type(&self, port: i64) -> visual_shader_node::PortType {
            unimplemented!()
        }
        fn get_input_port_name(&self, port: i64) -> GodotString {
            unimplemented!()
        }
        fn get_output_port_count(&self) -> i64 {
            unimplemented!()
        }
        fn get_output_port_type(&self, port: i64) -> visual_shader_node::PortType {
            unimplemented!()
        }
        fn get_output_port_name(&self, port: i64) -> GodotString {
            unimplemented!()
        }
        fn get_code(
            &self,
            input_vars: Array<GodotString>,
            output_vars: Array<GodotString>,
            mode: shader::Mode,
            type_: visual_shader::Type,
        ) -> GodotString {
            unimplemented!()
        }
        fn get_func_code(&self, mode: shader::Mode, type_: visual_shader::Type) -> GodotString {
            unimplemented!()
        }
        fn get_global_code(&self, mode: shader::Mode) -> GodotString {
            unimplemented!()
        }
        fn is_highend(&self) -> bool {
            unimplemented!()
        }
        fn is_available(&self, mode: shader::Mode, type_: visual_shader::Type) -> bool {
            unimplemented!()
        }
    }
    impl VisualShaderNodeCustom {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeCustom");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for VisualShaderNodeCustom {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeCustom";
    }
