...
pub(super) mod re_export {
    ...
    pub trait PrimitiveMeshVirtual:
    ...
    impl PrimitiveMesh {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("PrimitiveMesh");
                let __object_ptr =
        ...
        pub fn set_material(&mut self, material: Gd<Material>) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PrimitiveMesh" , "set_material" , 2757459619i64);
        ...
        pub fn get_material(&self) -> Option<Gd<Material>> {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PrimitiveMesh" , "get_material" , 5934680i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn get_mesh_arrays(&self) -> VariantArray {
            unsafe {
                let __class_name = StringName::from("PrimitiveMesh");
                let __method_name = StringName::from("get_mesh_arrays");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3995934104i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PrimitiveMesh" , "get_mesh_arrays" , 3995934104i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_custom_aabb(&mut self, aabb: Aabb) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PrimitiveMesh" , "set_custom_aabb" , 259215842i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_custom_aabb(&self) -> Aabb {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PrimitiveMesh" , "get_custom_aabb" , 1068685055i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_flip_faces(&mut self, flip_faces: bool) {
            unsafe {
                let __class_name = StringName::from("PrimitiveMesh");
                let __method_name = StringName::from("set_flip_faces");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PrimitiveMesh" , "set_flip_faces" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<bool as sys::GodotFfi>::sys_const(&flip_faces)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        ...
        pub fn get_flip_faces(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("PrimitiveMesh");
                let __method_name = StringName::from("get_flip_faces");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PrimitiveMesh" , "get_flip_faces" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_add_uv2(&mut self, add_uv2: bool) {
            unsafe {
                let __class_name = StringName::from("PrimitiveMesh");
                let __method_name = StringName::from("set_add_uv2");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PrimitiveMesh" , "set_add_uv2" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<bool as sys::GodotFfi>::sys_const(&add_uv2)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        ...
        pub fn get_add_uv2(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("PrimitiveMesh");
                let __method_name = StringName::from("get_add_uv2");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PrimitiveMesh" , "get_add_uv2" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <bool as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn set_uv2_padding(&mut self, uv2_padding: f64) {
            unsafe {
                let __class_name = StringName::from("PrimitiveMesh");
                let __method_name = StringName::from("set_uv2_padding");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    373806689i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PrimitiveMesh" , "set_uv2_padding" , 373806689i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<f64 as sys::GodotFfi>::sys_const(&uv2_padding)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        }
        pub fn get_uv2_padding(&self) -> f64 {
            unsafe {
                let __class_name = StringName::from("PrimitiveMesh");
                let __method_name = StringName::from("get_uv2_padding");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1740695150i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PrimitiveMesh" , "get_uv2_padding" , 1740695150i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for PrimitiveMesh {
        ...
        const CLASS_NAME: &'static str = "PrimitiveMesh";
    }
