...
pub(super) mod re_export {
    ...
    impl Material {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("Material");
                let __object_ptr =
        ...
        pub fn set_next_pass(&mut self, next_pass: Gd<Material>) {
            unsafe {
                let __class_name = StringName::from("Material");
                let __method_name = StringName::from("set_next_pass");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2757459619i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Material" , "set_next_pass" , 2757459619i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<Gd<Material> as AsArg>::as_arg_ptr(&next_pass)];
        ...
        pub fn get_next_pass(&self) -> Option<Gd<Material>> {
            unsafe {
                let __class_name = StringName::from("Material");
                let __method_name = StringName::from("get_next_pass");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    5934680i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Material" , "get_next_pass" , 5934680i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_render_priority(&mut self, priority: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Material" , "set_render_priority" , 1286410249i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_render_priority(&self) -> i64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Material" , "get_render_priority" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn inspect_native_shader_code(&mut self) {
            unsafe {
                let __class_name = StringName::from("Material");
                let __method_name = StringName::from("inspect_native_shader_code");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3218959716i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Material" , "inspect_native_shader_code" , 3218959716i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
        ...
        pub fn create_placeholder(&self) -> Option<Gd<Resource>> {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Material" , "create_placeholder" , 121922552i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
