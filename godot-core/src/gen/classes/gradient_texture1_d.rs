...
pub(super) mod re_export {
    ...
    pub trait GradientTexture1DVirtual:
    ...
    impl GradientTexture1D {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("GradientTexture1D");
                let __object_ptr =
        ...
        pub fn set_gradient(&mut self, gradient: Gd<Gradient>) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GradientTexture1D" , "set_gradient" , 2756054477i64);
        ...
        pub fn get_gradient(&self) -> Option<Gd<Gradient>> {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GradientTexture1D" , "get_gradient" , 132272999i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_width(&mut self, width: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GradientTexture1D" , "set_width" , 1286410249i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn set_use_hdr(&mut self, enabled: bool) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GradientTexture1D" , "set_use_hdr" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn is_using_hdr(&self) -> bool {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GradientTexture1D" , "is_using_hdr" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for GradientTexture1D {
        ...
        const CLASS_NAME: &'static str = "GradientTexture1D";
    }
