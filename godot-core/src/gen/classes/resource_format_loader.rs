...
pub(super) mod re_export {
    ...
    pub trait ResourceFormatLoaderVirtual:
        crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api
    {
        ...
        fn rename_dependencies(&self, path: GodotString, renames: Dictionary) -> global::Error {
            unimplemented!()
        }
    ...
    impl ResourceFormatLoader {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ResourceFormatLoader");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for ResourceFormatLoader {
        ...
        const CLASS_NAME: &'static str = "ResourceFormatLoader";
    }
