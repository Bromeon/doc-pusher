...
pub(super) mod re_export {
    ...
    pub trait AnimationRootNodeVirtual:
    ...
    impl AnimationRootNode {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("AnimationRootNode");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for AnimationRootNode {
        ...
        const CLASS_NAME: &'static str = "AnimationRootNode";
    }
