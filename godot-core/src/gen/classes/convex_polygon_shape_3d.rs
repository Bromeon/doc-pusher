...
pub(super) mod re_export {
    ...
    pub trait ConvexPolygonShape3DVirtual:
    ...
    impl ConvexPolygonShape3D {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ConvexPolygonShape3D");
                let __object_ptr =
        ...
        pub fn set_points(&mut self, points: PackedVector3Array) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ConvexPolygonShape3D" , "set_points" , 334873810i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<PackedVector3Array as sys::GodotFfi>::sys_const(&points)];
        ...
        pub fn get_points(&self) -> PackedVector3Array {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ConvexPolygonShape3D" , "get_points" , 497664490i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for ConvexPolygonShape3D {
        ...
        const CLASS_NAME: &'static str = "ConvexPolygonShape3D";
    }
