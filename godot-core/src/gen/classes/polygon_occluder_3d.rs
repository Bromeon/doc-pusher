...
pub(super) mod re_export {
    ...
    pub trait PolygonOccluder3DVirtual:
    ...
    impl PolygonOccluder3D {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("PolygonOccluder3D");
                let __object_ptr =
        ...
        pub fn set_polygon(&mut self, polygon: PackedVector2Array) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PolygonOccluder3D" , "set_polygon" , 1509147220i64);
        ...
        pub fn get_polygon(&self) -> PackedVector2Array {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PolygonOccluder3D" , "get_polygon" , 2961356807i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for PolygonOccluder3D {
        ...
        const CLASS_NAME: &'static str = "PolygonOccluder3D";
    }
