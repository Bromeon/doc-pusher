...
pub(super) mod re_export {
    ...
    pub trait ScriptExtensionVirtual:
        crate::obj::GodotClass + crate::private::You_forgot_the_attribute__godot_api
    {
        ...
        fn reload(&mut self, keep_state: bool) -> global::Error {
            unimplemented!()
        }
    ...
    impl ScriptExtension {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ScriptExtension");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for ScriptExtension {
        ...
        const CLASS_NAME: &'static str = "ScriptExtension";
    }
