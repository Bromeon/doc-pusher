...
pub(super) mod re_export {
    ...
    pub trait PhysicsDirectSpaceState2DExtensionVirtual:
    ...
    impl PhysicsDirectSpaceState2DExtension {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("PhysicsDirectSpaceState2DExtension");
                let __object_ptr =
        ...
        pub fn is_body_excluded_from_query(&self, body: Rid) -> bool {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PhysicsDirectSpaceState2DExtension" , "is_body_excluded_from_query" , 4155700596i64);
    ...
    impl crate::obj::GodotClass for PhysicsDirectSpaceState2DExtension {
        ...
        const CLASS_NAME: &'static str = "PhysicsDirectSpaceState2DExtension";
    }
    ...
    impl crate::obj::Inherits<crate::engine::PhysicsDirectSpaceState2D>
        for PhysicsDirectSpaceState2DExtension
    {
    }
    ...
    macro_rules! inherits_transitive_PhysicsDirectSpaceState2DExtension {
        ($ Class : ident) => {
            impl ::godot::obj::Inherits<::godot::engine::PhysicsDirectSpaceState2DExtension>
                for $Class
            {
            }
