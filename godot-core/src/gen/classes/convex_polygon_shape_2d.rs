...
pub(super) mod re_export {
    ...
    pub trait ConvexPolygonShape2DVirtual:
    ...
    impl ConvexPolygonShape2D {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ConvexPolygonShape2D");
                let __object_ptr =
        ...
        pub fn set_point_cloud(&mut self, point_cloud: PackedVector2Array) {
            unsafe {
                let __class_name = StringName::from("ConvexPolygonShape2D");
                let __method_name = StringName::from("set_point_cloud");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1509147220i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ConvexPolygonShape2D" , "set_point_cloud" , 1509147220i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<PackedVector2Array as sys::GodotFfi>::sys_const(
                    &point_cloud,
                )];
        ...
        pub fn set_points(&mut self, points: PackedVector2Array) {
            unsafe {
                let __class_name = StringName::from("ConvexPolygonShape2D");
                let __method_name = StringName::from("set_points");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1509147220i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ConvexPolygonShape2D" , "set_points" , 1509147220i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_points(&self) -> PackedVector2Array {
            unsafe {
                let __class_name = StringName::from("ConvexPolygonShape2D");
                let __method_name = StringName::from("get_points");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2961356807i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ConvexPolygonShape2D" , "get_points" , 2961356807i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for ConvexPolygonShape2D {
        ...
        const CLASS_NAME: &'static str = "ConvexPolygonShape2D";
    }
