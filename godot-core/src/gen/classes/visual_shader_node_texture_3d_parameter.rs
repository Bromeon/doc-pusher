...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeTexture3DParameterVirtual:
    ...
    impl VisualShaderNodeTexture3DParameter {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeTexture3DParameter");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for VisualShaderNodeTexture3DParameter {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeTexture3DParameter";
    }
    ...
    impl crate::obj::Inherits<crate::engine::VisualShaderNodeTextureParameter>
        for VisualShaderNodeTexture3DParameter
    {
    }
    ...
    macro_rules! inherits_transitive_VisualShaderNodeTexture3DParameter {
        ($ Class : ident) => {
            impl ::godot::obj::Inherits<::godot::engine::VisualShaderNodeTexture3DParameter>
                for $Class
            {
            }
