...
pub(super) mod re_export {
    ...
    impl AesContext {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("AESContext");
                let __object_ptr =
        ...
        pub fn start(
            ...
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AESContext" , "start" , 3167574919i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <aes_context::Mode as sys::GodotFfi>::sys_const(&mode),
                    <PackedByteArray as sys::GodotFfi>::sys_const(&key),
                    <PackedByteArray as sys::GodotFfi>::sys_const(&iv),
                ];
        ...
        pub fn update(&mut self, src: PackedByteArray) -> PackedByteArray {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AESContext" , "update" , 527836100i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<PackedByteArray as sys::GodotFfi>::sys_const(&src)];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn get_iv_state(&mut self) -> PackedByteArray {
            unsafe {
                let __class_name = StringName::from("AESContext");
                let __method_name = StringName::from("get_iv_state");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2115431945i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AESContext" , "get_iv_state" , 2115431945i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <PackedByteArray as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn finish(&mut self) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AESContext" , "finish" , 3218959716i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for AesContext {
        ...
        const CLASS_NAME: &'static str = "AESContext";
    }
...
impl Mode {
    pub const MODE_ECB_ENCRYPT: Self = Self { ord: 0 };
    pub const MODE_ECB_DECRYPT: Self = Self { ord: 1 };
    pub const MODE_CBC_ENCRYPT: Self = Self { ord: 2 };
    pub const MODE_CBC_DECRYPT: Self = Self { ord: 3 };
    pub const MODE_MAX: Self = Self { ord: 4 };
}
