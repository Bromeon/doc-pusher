...
pub(super) mod re_export {
    ...
    pub trait LightmapperRdVirtual:
    ...
    impl LightmapperRd {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("LightmapperRD");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for LightmapperRd {
        ...
        const CLASS_NAME: &'static str = "LightmapperRD";
    }
