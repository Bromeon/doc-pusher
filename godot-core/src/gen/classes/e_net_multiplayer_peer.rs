...
pub(super) mod re_export {
    ...
    pub trait ENetMultiplayerPeerVirtual:
    ...
    impl ENetMultiplayerPeer {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ENetMultiplayerPeer");
                let __object_ptr =
        ...
        pub fn create_server(
            ...
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ENetMultiplayerPeer" , "create_server" , 1616151701i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <i64 as sys::GodotFfi>::sys_const(&port),
                    <i64 as sys::GodotFfi>::sys_const(&max_clients),
        ...
        pub fn create_client(
            ...
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ENetMultiplayerPeer" , "create_client" , 920217784i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <GodotString as sys::GodotFfi>::sys_const(&address),
                    <i64 as sys::GodotFfi>::sys_const(&port),
                    <i64 as sys::GodotFfi>::sys_const(&channel_count),
                    <i64 as sys::GodotFfi>::sys_const(&in_bandwidth),
                    <i64 as sys::GodotFfi>::sys_const(&out_bandwidth),
                    <i64 as sys::GodotFfi>::sys_const(&local_port),
                ];
                let __args_ptr = __args.as_ptr();
                <global::Error as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
        ...
        pub fn create_mesh(&mut self, unique_id: i64) -> global::Error {
            unsafe {
                let __class_name = StringName::from("ENetMultiplayerPeer");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ENetMultiplayerPeer" , "create_mesh" , 844576869i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<i64 as sys::GodotFfi>::sys_const(&unique_id)];
                let __args_ptr = __args.as_ptr();
                <global::Error as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                })
        ...
        pub fn add_mesh_peer(&mut self, peer_id: i64, host: Gd<ENetConnection>) -> global::Error {
            unsafe {
                let __class_name = StringName::from("ENetMultiplayerPeer");
                let __method_name = StringName::from("add_mesh_peer");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1293458335i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ENetMultiplayerPeer" , "add_mesh_peer" , 1293458335i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <i64 as sys::GodotFfi>::sys_const(&peer_id),
                    <Gd<ENetConnection> as AsArg>::as_arg_ptr(&host),
                ];
                let __args_ptr = __args.as_ptr();
                <global::Error as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
        ...
        pub fn set_bind_ip(&mut self, ip: GodotString) {
            unsafe {
                let __class_name = StringName::from("ENetMultiplayerPeer");
                let __method_name = StringName::from("set_bind_ip");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    83702148i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ENetMultiplayerPeer" , "set_bind_ip" , 83702148i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<GodotString as sys::GodotFfi>::sys_const(&ip)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        }
        pub fn get_host(&self) -> Option<Gd<ENetConnection>> {
            unsafe {
                let __class_name = StringName::from("ENetMultiplayerPeer");
                let __method_name = StringName::from("get_host");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    4103238886i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ENetMultiplayerPeer" , "get_host" , 4103238886i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <Gd<ENetConnection>>::from_sys_init_opt(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                })
            }
        }
        pub fn get_peer(&self, id: i64) -> Option<Gd<ENetPacketPeer>> {
            unsafe {
                let __class_name = StringName::from("ENetMultiplayerPeer");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ENetMultiplayerPeer" , "get_peer" , 3793311544i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
    ...
    impl crate::obj::GodotClass for ENetMultiplayerPeer {
        ...
        const CLASS_NAME: &'static str = "ENetMultiplayerPeer";
    }
