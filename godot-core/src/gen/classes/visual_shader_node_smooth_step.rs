...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeSmoothStepVirtual:
    ...
    impl VisualShaderNodeSmoothStep {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeSmoothStep");
                let __object_ptr =
        ...
        pub fn set_op_type(&mut self, op_type: visual_shader_node_smooth_step::OpType) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeSmoothStep");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeSmoothStep" , "set_op_type" , 2427426148i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <visual_shader_node_smooth_step::OpType as sys::GodotFfi>::sys_const(&op_type),
                ];
        ...
        pub fn get_op_type(&self) -> visual_shader_node_smooth_step::OpType {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeSmoothStep");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeSmoothStep" , "get_op_type" , 359640855i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <visual_shader_node_smooth_step::OpType as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
    ...
    impl crate::obj::GodotClass for VisualShaderNodeSmoothStep {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeSmoothStep";
    }
