...
pub(super) mod re_export {
    ...
    impl CurveTexture {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("CurveTexture");
                let __object_ptr =
        ...
        pub fn set_width(&mut self, width: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveTexture" , "set_width" , 1286410249i64);
        ...
        pub fn set_curve(&mut self, curve: Gd<Curve>) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveTexture" , "set_curve" , 270443179i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_curve(&self) -> Option<Gd<Curve>> {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveTexture" , "get_curve" , 2460114913i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_texture_mode(&mut self, texture_mode: curve_texture::TextureMode) {
            unsafe {
                let __class_name = StringName::from("CurveTexture");
                let __method_name = StringName::from("set_texture_mode");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1321955367i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveTexture" , "set_texture_mode" , 1321955367i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<curve_texture::TextureMode as sys::GodotFfi>::sys_const(
                    &texture_mode,
                )];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
        ...
        pub fn get_texture_mode(&self) -> curve_texture::TextureMode {
            unsafe {
                let __class_name = StringName::from("CurveTexture");
                let __method_name = StringName::from("get_texture_mode");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    715756376i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveTexture" , "get_texture_mode" , 715756376i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <curve_texture::TextureMode as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                })
            }
        }
    ...
    impl crate::obj::GodotClass for CurveTexture {
        ...
        const CLASS_NAME: &'static str = "CurveTexture";
    }
...
impl TextureMode {
    pub const TEXTURE_MODE_RGB: Self = Self { ord: 0 };
    pub const TEXTURE_MODE_RED: Self = Self { ord: 1 };
}
...
unsafe impl sys::GodotFfi for TextureMode {
