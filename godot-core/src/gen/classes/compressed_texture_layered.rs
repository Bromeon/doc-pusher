...
pub(super) mod re_export {
    ...
    impl CompressedTextureLayered {
        ...
        pub fn load(&mut self, path: GodotString) -> global::Error {
            unsafe {
                let __class_name = StringName::from("CompressedTextureLayered");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CompressedTextureLayered" , "load" , 166001499i64);
        ...
        pub fn get_load_path(&self) -> GodotString {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CompressedTextureLayered" , "get_load_path" , 201670096i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for CompressedTextureLayered {
        ...
        const CLASS_NAME: &'static str = "CompressedTextureLayered";
    }
    impl crate::obj::EngineClass for CompressedTextureLayered {
    ...
    impl crate::obj::Inherits<crate::engine::TextureLayered> for CompressedTextureLayered {}
    impl crate::obj::Inherits<crate::engine::Texture> for CompressedTextureLayered {}
    impl crate::obj::Inherits<crate::engine::Resource> for CompressedTextureLayered {}
    impl crate::obj::Inherits<crate::engine::RefCounted> for CompressedTextureLayered {}
    impl crate::obj::Inherits<crate::engine::Object> for CompressedTextureLayered {}
    ...
    macro_rules! inherits_transitive_CompressedTextureLayered {
        ($ Class : ident) => {
