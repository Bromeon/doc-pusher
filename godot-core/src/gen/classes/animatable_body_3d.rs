...
pub(super) mod re_export {
    ...
    pub trait AnimatableBody3DVirtual:
    ...
    impl AnimatableBody3D {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("AnimatableBody3D");
                let __object_ptr =
        ...
        pub fn set_sync_to_physics(&mut self, enable: bool) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AnimatableBody3D" , "set_sync_to_physics" , 2586408642i64);
        ...
        pub fn is_sync_to_physics_enabled(&self) -> bool {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AnimatableBody3D" , "is_sync_to_physics_enabled" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for AnimatableBody3D {
        ...
        const CLASS_NAME: &'static str = "AnimatableBody3D";
    }
