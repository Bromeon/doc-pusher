...
pub(super) mod re_export {
    ...
    pub trait PhysicsServer2DManagerVirtual:
    ...
    impl PhysicsServer2DManager {
        pub fn singleton() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("PhysicsServer2DManager");
                let __object_ptr =
        ...
        pub fn register_server(&mut self, name: GodotString, create_callback: Callable) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PhysicsServer2DManager" , "register_server" , 2137474292i64);
        ...
        pub fn set_default_server(&mut self, name: GodotString, priority: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PhysicsServer2DManager" , "set_default_server" , 2956805083i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <GodotString as sys::GodotFfi>::sys_const(&name),
    ...
    impl crate::obj::GodotClass for PhysicsServer2DManager {
        ...
        const CLASS_NAME: &'static str = "PhysicsServer2DManager";
    }
