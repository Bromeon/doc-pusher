...
pub(super) mod re_export {
    ...
    impl ButtonGroup {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ButtonGroup");
                let __object_ptr =
        ...
        pub fn get_pressed_button(&mut self) -> Option<Gd<BaseButton>> {
            unsafe {
                let __class_name = StringName::from("ButtonGroup");
                let __method_name = StringName::from("get_pressed_button");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3886434893i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ButtonGroup" , "get_pressed_button" , 3886434893i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <Gd<BaseButton>>::from_sys_init_opt(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                })
            }
        }
        pub fn get_buttons(&mut self) -> Array<Gd<BaseButton>> {
            unsafe {
                let __class_name = StringName::from("ButtonGroup");
                let __method_name = StringName::from("get_buttons");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2915620761i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ButtonGroup" , "get_buttons" , 2915620761i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <Array<Gd<BaseButton>> as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                })
            }
        }
    ...
    impl crate::obj::GodotClass for ButtonGroup {
        ...
        const CLASS_NAME: &'static str = "ButtonGroup";
    }
