...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeProximityFadeVirtual:
    ...
    impl VisualShaderNodeProximityFade {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeProximityFade");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for VisualShaderNodeProximityFade {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeProximityFade";
    }
