...
pub(super) mod re_export {
    ...
    impl ColorRect {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ColorRect");
                let __object_ptr =
        ...
        pub fn set_color(&mut self, color: Color) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ColorRect" , "set_color" , 2920490490i64);
        ...
        pub fn get_color(&self) -> Color {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ColorRect" , "get_color" , 3444240500i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for ColorRect {
        ...
        const CLASS_NAME: &'static str = "ColorRect";
    }
    impl crate::obj::EngineClass for ColorRect {
    ...
    impl crate::obj::Inherits<crate::engine::Control> for ColorRect {}
    impl crate::obj::Inherits<crate::engine::CanvasItem> for ColorRect {}
    impl crate::obj::Inherits<crate::engine::Node> for ColorRect {}
    impl crate::obj::Inherits<crate::engine::Object> for ColorRect {}
    ...
    macro_rules! inherits_transitive_ColorRect {
        ($ Class : ident) => {
            impl ::godot::obj::Inherits<::godot::engine::ColorRect> for $Class {}
