...
pub(super) mod re_export {
    ...
    pub trait ResourceImporterVirtual:
    ...
    impl crate::obj::GodotClass for ResourceImporter {
        ...
        const CLASS_NAME: &'static str = "ResourceImporter";
    }
...
impl ImportOrder {
    pub const IMPORT_ORDER_DEFAULT: Self = Self { ord: 0 };
    pub const IMPORT_ORDER_SCENE: Self = Self { ord: 100 };
}
impl crate::obj::EngineEnum for ImportOrder {
    fn try_from_ord(ord: i32) -> Option<Self> {
        match ord {
            ord @ 0i32 | ord @ 100i32 => Some(Self { ord }),
            _ => None,
        }
    }
    fn ord(self) -> i32 {
...
unsafe impl sys::GodotFfi for ImportOrder {
