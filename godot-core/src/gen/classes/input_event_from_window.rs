...
pub(super) mod re_export {
    ...
    pub trait InputEventFromWindowVirtual:
    ...
    impl InputEventFromWindow {
        ...
        pub fn set_window_id(&mut self, id: i64) {
            unsafe {
                let __class_name = StringName::from("InputEventFromWindow");
                let __method_name = StringName::from("set_window_id");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1286410249i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventFromWindow" , "set_window_id" , 1286410249i64);
        ...
        pub fn get_window_id(&self) -> i64 {
            unsafe {
                let __class_name = StringName::from("InputEventFromWindow");
                let __method_name = StringName::from("get_window_id");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3905245786i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventFromWindow" , "get_window_id" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for InputEventFromWindow {
        ...
        const CLASS_NAME: &'static str = "InputEventFromWindow";
    }
