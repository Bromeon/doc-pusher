...
pub(super) mod re_export {
    ...
    impl PckPacker {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("PCKPacker");
                let __object_ptr =
        ...
        pub fn pck_start(
            ...
            unsafe {
                let __class_name = StringName::from("PCKPacker");
                let __method_name = StringName::from("pck_start");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3232891339i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PCKPacker" , "pck_start" , 3232891339i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <GodotString as sys::GodotFfi>::sys_const(&pck_name),
                    <i64 as sys::GodotFfi>::sys_const(&alignment),
                    <GodotString as sys::GodotFfi>::sys_const(&key),
                    <bool as sys::GodotFfi>::sys_const(&encrypt_directory),
                ];
        ...
        pub fn add_file(
            &mut self,
            pck_path: GodotString,
            source_path: GodotString,
            encrypt: bool,
        ) -> global::Error {
            unsafe {
                let __class_name = StringName::from("PCKPacker");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PCKPacker" , "add_file" , 2215643711i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <GodotString as sys::GodotFfi>::sys_const(&pck_path),
                    <GodotString as sys::GodotFfi>::sys_const(&source_path),
                    <bool as sys::GodotFfi>::sys_const(&encrypt),
                ];
                let __args_ptr = __args.as_ptr();
                <global::Error as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
        ...
        pub fn flush(&mut self, verbose: bool) -> global::Error {
            unsafe {
                let __class_name = StringName::from("PCKPacker");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PCKPacker" , "flush" , 1633102583i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<bool as sys::GodotFfi>::sys_const(&verbose)];
                let __args_ptr = __args.as_ptr();
                <global::Error as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                })
    ...
    impl crate::obj::GodotClass for PckPacker {
        ...
        const CLASS_NAME: &'static str = "PCKPacker";
    }
