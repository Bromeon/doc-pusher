...
pub(super) mod re_export {
    ...
    pub trait PacketPeerExtensionVirtual:
    ...
    impl PacketPeerExtension {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("PacketPeerExtension");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for PacketPeerExtension {
        ...
        const CLASS_NAME: &'static str = "PacketPeerExtension";
    }
