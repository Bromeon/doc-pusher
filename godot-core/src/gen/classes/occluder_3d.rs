...
pub(super) mod re_export {
    ...
    impl Occluder3D {
        ...
        pub fn get_vertices(&self) -> PackedVector3Array {
            unsafe {
                let __class_name = StringName::from("Occluder3D");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Occluder3D" , "get_vertices" , 497664490i64);
        ...
        pub fn get_indices(&self) -> PackedInt32Array {
            unsafe {
                let __class_name = StringName::from("Occluder3D");
                let __method_name = StringName::from("get_indices");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1930428628i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "Occluder3D" , "get_indices" , 1930428628i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for Occluder3D {
        ...
        const CLASS_NAME: &'static str = "Occluder3D";
    }
