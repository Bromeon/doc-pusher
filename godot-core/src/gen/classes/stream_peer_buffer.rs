...
pub(super) mod re_export {
    ...
    pub trait StreamPeerBufferVirtual:
    ...
    impl StreamPeerBuffer {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("StreamPeerBuffer");
                let __object_ptr =
        ...
        pub fn seek(&mut self, position: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerBuffer" , "seek" , 1286410249i64);
        ...
        pub fn get_size(&self) -> i64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerBuffer" , "get_size" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn get_position(&self) -> i64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerBuffer" , "get_position" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <i64 as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn resize(&mut self, size: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerBuffer" , "resize" , 1286410249i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn set_data_array(&mut self, data: PackedByteArray) {
            unsafe {
                let __class_name = StringName::from("StreamPeerBuffer");
                let __method_name = StringName::from("set_data_array");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2971499966i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerBuffer" , "set_data_array" , 2971499966i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_data_array(&self) -> PackedByteArray {
            unsafe {
                let __class_name = StringName::from("StreamPeerBuffer");
                let __method_name = StringName::from("get_data_array");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2362200018i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerBuffer" , "get_data_array" , 2362200018i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn clear(&mut self) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerBuffer" , "clear" , 3218959716i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
        ...
        pub fn duplicate(&self) -> Option<Gd<StreamPeerBuffer>> {
            unsafe {
                let __class_name = StringName::from("StreamPeerBuffer");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerBuffer" , "duplicate" , 2474064677i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <Gd<StreamPeerBuffer>>::from_sys_init_opt(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                })
            }
        }
    ...
    impl crate::obj::GodotClass for StreamPeerBuffer {
        ...
        const CLASS_NAME: &'static str = "StreamPeerBuffer";
    }
