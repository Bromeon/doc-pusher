...
pub(super) mod re_export {
    ...
    impl EditorInspector {
        ...
        pub fn get_selected_path(&self) -> GodotString {
            unsafe {
                let __class_name = StringName::from("EditorInspector");
                let __method_name = StringName::from("get_selected_path");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    201670096i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "EditorInspector" , "get_selected_path" , 201670096i64);
    ...
    impl crate::obj::GodotClass for EditorInspector {
        type Base = crate::engine::ScrollContainer;
        type Declarer = crate::obj::dom::EngineDomain;
        type Mem = crate::obj::mem::ManualMemory;
        const CLASS_NAME: &'static str = "EditorInspector";
    }
    impl crate::obj::EngineClass for EditorInspector {
    ...
    impl crate::obj::Inherits<crate::engine::ScrollContainer> for EditorInspector {}
    impl crate::obj::Inherits<crate::engine::Container> for EditorInspector {}
    impl crate::obj::Inherits<crate::engine::Control> for EditorInspector {}
    impl crate::obj::Inherits<crate::engine::CanvasItem> for EditorInspector {}
    impl crate::obj::Inherits<crate::engine::Node> for EditorInspector {}
    impl crate::obj::Inherits<crate::engine::Object> for EditorInspector {}
    impl std::ops::Deref for EditorInspector {
        type Target = crate::engine::ScrollContainer;
    ...
    macro_rules! inherits_transitive_EditorInspector {
        ($ Class : ident) => {
            impl ::godot::obj::Inherits<::godot::engine::EditorInspector> for $Class {}
