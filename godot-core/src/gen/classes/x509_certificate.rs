...
pub(super) mod re_export {
    ...
    pub trait X509CertificateVirtual:
    ...
    impl X509Certificate {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("X509Certificate");
                let __object_ptr =
        ...
        pub fn save(&mut self, path: GodotString) -> global::Error {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "X509Certificate" , "save" , 166001499i64);
        ...
        pub fn load(&mut self, path: GodotString) -> global::Error {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "X509Certificate" , "load" , 166001499i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<GodotString as sys::GodotFfi>::sys_const(&path)];
                let __args_ptr = __args.as_ptr();
                <global::Error as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
