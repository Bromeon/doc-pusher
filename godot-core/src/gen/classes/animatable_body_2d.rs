...
pub(super) mod re_export {
    ...
    pub trait AnimatableBody2DVirtual:
    ...
    impl AnimatableBody2D {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("AnimatableBody2D");
                let __object_ptr =
        ...
        pub fn set_sync_to_physics(&mut self, enable: bool) {
            unsafe {
                let __class_name = StringName::from("AnimatableBody2D");
                let __method_name = StringName::from("set_sync_to_physics");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AnimatableBody2D" , "set_sync_to_physics" , 2586408642i64);
        ...
        pub fn is_sync_to_physics_enabled(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("AnimatableBody2D");
                let __method_name = StringName::from("is_sync_to_physics_enabled");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AnimatableBody2D" , "is_sync_to_physics_enabled" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for AnimatableBody2D {
        ...
        const CLASS_NAME: &'static str = "AnimatableBody2D";
    }
