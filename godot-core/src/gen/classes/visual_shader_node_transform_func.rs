...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeTransformFuncVirtual:
    ...
    impl VisualShaderNodeTransformFunc {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeTransformFunc");
                let __object_ptr =
        ...
        pub fn set_function(&mut self, func: visual_shader_node_transform_func::Function) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeTransformFunc");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeTransformFunc" , "set_function" , 2900990409i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <visual_shader_node_transform_func::Function as sys::GodotFfi>::sys_const(
                        &func,
                    ),
                ];
        ...
        pub fn get_function(&self) -> visual_shader_node_transform_func::Function {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeTransformFunc");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeTransformFunc" , "get_function" , 2839926569i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                < visual_shader_node_transform_func :: Function as sys :: GodotFfi > :: from_sys_init_default (| return_ptr | { __call_fn (__method_bind , self . object_ptr , __args_ptr , return_ptr) ; })
            }
        }
    }
    impl crate::obj::GodotClass for VisualShaderNodeTransformFunc {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeTransformFunc";
    }
...
impl Function {
    pub const FUNC_INVERSE: Self = Self { ord: 0 };
    pub const FUNC_TRANSPOSE: Self = Self { ord: 1 };
