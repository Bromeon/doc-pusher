...
pub(super) mod re_export {
    ...
    impl AnimationNodeSync {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("AnimationNodeSync");
                let __object_ptr =
        ...
        pub fn set_use_sync(&mut self, enable: bool) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AnimationNodeSync" , "set_use_sync" , 2586408642i64);
        ...
        pub fn is_using_sync(&self) -> bool {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AnimationNodeSync" , "is_using_sync" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for AnimationNodeSync {
        ...
        const CLASS_NAME: &'static str = "AnimationNodeSync";
    }
    impl crate::obj::EngineClass for AnimationNodeSync {
    ...
    impl crate::obj::Inherits<crate::engine::AnimationNode> for AnimationNodeSync {}
    impl crate::obj::Inherits<crate::engine::Resource> for AnimationNodeSync {}
    impl crate::obj::Inherits<crate::engine::RefCounted> for AnimationNodeSync {}
    impl crate::obj::Inherits<crate::engine::Object> for AnimationNodeSync {}
    ...
    macro_rules! inherits_transitive_AnimationNodeSync {
        ($ Class : ident) => {
