...
pub(super) mod re_export {
    ...
    pub trait EditorSceneFormatImporterVirtual:
    ...
    impl crate::obj::GodotClass for EditorSceneFormatImporter {
        ...
        const CLASS_NAME: &'static str = "EditorSceneFormatImporter";
    }
