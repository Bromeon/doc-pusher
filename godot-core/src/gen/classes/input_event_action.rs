...
pub(super) mod re_export {
    ...
    pub trait InputEventActionVirtual:
    ...
    impl InputEventAction {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("InputEventAction");
                let __object_ptr =
        ...
        pub fn set_action(&mut self, action: StringName) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventAction" , "set_action" , 3304788590i64);
        ...
        pub fn get_action(&self) -> StringName {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventAction" , "get_action" , 2002593661i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_pressed(&mut self, pressed: bool) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventAction" , "set_pressed" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn set_strength(&mut self, strength: f64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventAction" , "set_strength" , 373806689i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_strength(&self) -> f64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventAction" , "get_strength" , 1740695150i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for InputEventAction {
        ...
        const CLASS_NAME: &'static str = "InputEventAction";
    }
