...
pub(super) mod re_export {
    ...
    pub trait AnimationNodeBlend2Virtual:
    ...
    impl AnimationNodeBlend2 {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("AnimationNodeBlend2");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for AnimationNodeBlend2 {
        ...
        const CLASS_NAME: &'static str = "AnimationNodeBlend2";
    }
