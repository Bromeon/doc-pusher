...
pub(super) mod re_export {
    ...
    pub trait ImageTextureLayeredVirtual:
    ...
    impl ImageTextureLayered {
        ...
        pub fn create_from_images(&mut self, images: Array<Gd<Image>>) -> global::Error {
            unsafe {
                let __class_name = StringName::from("ImageTextureLayered");
                let __method_name = StringName::from("create_from_images");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2785773503i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ImageTextureLayered" , "create_from_images" , 2785773503i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<Array<Gd<Image>> as sys::GodotFfi>::sys_const(&images)];
        ...
        pub fn update_layer(&mut self, image: Gd<Image>, layer: i64) {
            unsafe {
                let __class_name = StringName::from("ImageTextureLayered");
                let __method_name = StringName::from("update_layer");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3331733361i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ImageTextureLayered" , "update_layer" , 3331733361i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
    ...
    impl crate::obj::GodotClass for ImageTextureLayered {
        ...
        const CLASS_NAME: &'static str = "ImageTextureLayered";
    }
