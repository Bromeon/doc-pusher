...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeFloatOpVirtual:
    ...
    impl VisualShaderNodeFloatOp {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeFloatOp");
                let __object_ptr =
        ...
        pub fn set_operator(&mut self, op: visual_shader_node_float_op::Operator) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeFloatOp");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeFloatOp" , "set_operator" , 2488468047i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args =
                    [<visual_shader_node_float_op::Operator as sys::GodotFfi>::sys_const(&op)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        }
        pub fn get_operator(&self) -> visual_shader_node_float_op::Operator {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeFloatOp");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeFloatOp" , "get_operator" , 1867979390i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <visual_shader_node_float_op::Operator as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
    ...
    impl crate::obj::GodotClass for VisualShaderNodeFloatOp {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeFloatOp";
    }
...
impl Operator {
    ...
    pub const OP_ATAN2: Self = Self { ord: 8 };
    pub const OP_STEP: Self = Self { ord: 9 };
    pub const OP_ENUM_SIZE: Self = Self { ord: 10 };
}
