...
pub(super) mod re_export {
    ...
    pub trait AudioEffectPitchShiftVirtual:
    ...
    impl AudioEffectPitchShift {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("AudioEffectPitchShift");
                let __object_ptr =
        ...
        pub fn set_pitch_scale(&mut self, rate: f64) {
            unsafe {
                let __class_name = StringName::from("AudioEffectPitchShift");
                let __method_name = StringName::from("set_pitch_scale");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    373806689i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AudioEffectPitchShift" , "set_pitch_scale" , 373806689i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<f64 as sys::GodotFfi>::sys_const(&rate)];
        ...
        pub fn get_pitch_scale(&self) -> f64 {
            unsafe {
                let __class_name = StringName::from("AudioEffectPitchShift");
                let __method_name = StringName::from("get_pitch_scale");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1740695150i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AudioEffectPitchShift" , "get_pitch_scale" , 1740695150i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_oversampling(&mut self, amount: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AudioEffectPitchShift" , "set_oversampling" , 1286410249i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_oversampling(&self) -> i64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AudioEffectPitchShift" , "get_oversampling" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_fft_size(&mut self, size: audio_effect_pitch_shift::FFTSize) {
            unsafe {
                let __class_name = StringName::from("AudioEffectPitchShift");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AudioEffectPitchShift" , "set_fft_size" , 2323518741i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args =
                    [<audio_effect_pitch_shift::FFTSize as sys::GodotFfi>::sys_const(&size)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        }
        pub fn get_fft_size(&self) -> audio_effect_pitch_shift::FFTSize {
            unsafe {
                let __class_name = StringName::from("AudioEffectPitchShift");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AudioEffectPitchShift" , "get_fft_size" , 2361246789i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <audio_effect_pitch_shift::FFTSize as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
    ...
    impl crate::obj::GodotClass for AudioEffectPitchShift {
        ...
        const CLASS_NAME: &'static str = "AudioEffectPitchShift";
    }
