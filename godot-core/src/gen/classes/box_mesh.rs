...
pub(super) mod re_export {
    ...
    impl BoxMesh {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("BoxMesh");
                let __object_ptr =
        ...
        pub fn set_size(&mut self, size: Vector3) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "BoxMesh" , "set_size" , 3460891852i64);
        ...
        pub fn get_size(&self) -> Vector3 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "BoxMesh" , "get_size" , 3360562783i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_subdivide_width(&mut self, subdivide: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "BoxMesh" , "set_subdivide_width" , 1286410249i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_subdivide_width(&self) -> i64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "BoxMesh" , "get_subdivide_width" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_subdivide_height(&mut self, divisions: i64) {
            unsafe {
                let __class_name = StringName::from("BoxMesh");
                let __method_name = StringName::from("set_subdivide_height");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1286410249i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "BoxMesh" , "set_subdivide_height" , 1286410249i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<i64 as sys::GodotFfi>::sys_const(&divisions)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        ...
        pub fn get_subdivide_height(&self) -> i64 {
            unsafe {
                let __class_name = StringName::from("BoxMesh");
                let __method_name = StringName::from("get_subdivide_height");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3905245786i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "BoxMesh" , "get_subdivide_height" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <i64 as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn set_subdivide_depth(&mut self, divisions: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "BoxMesh" , "set_subdivide_depth" , 1286410249i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<i64 as sys::GodotFfi>::sys_const(&divisions)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
        ...
        pub fn get_subdivide_depth(&self) -> i64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "BoxMesh" , "get_subdivide_depth" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <i64 as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
    ...
    impl crate::obj::GodotClass for BoxMesh {
        ...
        const CLASS_NAME: &'static str = "BoxMesh";
    }
    impl crate::obj::EngineClass for BoxMesh {
    ...
    impl crate::obj::Inherits<crate::engine::PrimitiveMesh> for BoxMesh {}
    impl crate::obj::Inherits<crate::engine::Mesh> for BoxMesh {}
    impl crate::obj::Inherits<crate::engine::Resource> for BoxMesh {}
    impl crate::obj::Inherits<crate::engine::RefCounted> for BoxMesh {}
    impl crate::obj::Inherits<crate::engine::Object> for BoxMesh {}
    ...
    macro_rules! inherits_transitive_BoxMesh {
        ($ Class : ident) => {
            impl ::godot::obj::Inherits<::godot::engine::BoxMesh> for $Class {}
