...
pub(super) mod re_export {
    ...
    pub trait StreamPeerTcpVirtual:
    ...
    impl StreamPeerTcp {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("StreamPeerTCP");
                let __object_ptr =
        ...
        pub fn bind(&mut self, port: i64, host: GodotString) -> global::Error {
            unsafe {
                let __class_name = StringName::from("StreamPeerTCP");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerTCP" , "bind" , 4025329869i64);
        ...
        pub fn connect_to_host(&mut self, host: GodotString, port: i64) -> global::Error {
            unsafe {
                let __class_name = StringName::from("StreamPeerTCP");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerTCP" , "connect_to_host" , 993915709i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <GodotString as sys::GodotFfi>::sys_const(&host),
                    <i64 as sys::GodotFfi>::sys_const(&port),
        ...
        pub fn poll(&mut self) -> global::Error {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerTCP" , "poll" , 166280745i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <global::Error as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn get_status(&self) -> stream_peer_tcp::Status {
            unsafe {
                let __class_name = StringName::from("StreamPeerTCP");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerTCP" , "get_status" , 859471121i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <stream_peer_tcp::Status as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                })
            }
        }
        pub fn get_connected_host(&self) -> GodotString {
            unsafe {
                let __class_name = StringName::from("StreamPeerTCP");
                let __method_name = StringName::from("get_connected_host");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    201670096i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerTCP" , "get_connected_host" , 201670096i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn get_connected_port(&self) -> i64 {
            unsafe {
                let __class_name = StringName::from("StreamPeerTCP");
                let __method_name = StringName::from("get_connected_port");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3905245786i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerTCP" , "get_connected_port" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn get_local_port(&self) -> i64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerTCP" , "get_local_port" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <i64 as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn disconnect_from_host(&mut self) {
            unsafe {
                let __class_name = StringName::from("StreamPeerTCP");
                let __method_name = StringName::from("disconnect_from_host");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3218959716i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerTCP" , "disconnect_from_host" , 3218959716i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_no_delay(&mut self, enabled: bool) {
            unsafe {
                let __class_name = StringName::from("StreamPeerTCP");
                let __method_name = StringName::from("set_no_delay");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "StreamPeerTCP" , "set_no_delay" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
    ...
    impl crate::obj::GodotClass for StreamPeerTcp {
        ...
        const CLASS_NAME: &'static str = "StreamPeerTCP";
    }
...
impl Status {
    pub const STATUS_NONE: Self = Self { ord: 0 };
    pub const STATUS_CONNECTING: Self = Self { ord: 1 };
