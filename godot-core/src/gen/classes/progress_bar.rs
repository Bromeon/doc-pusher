...
pub(super) mod re_export {
    ...
    impl ProgressBar {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ProgressBar");
                let __object_ptr =
        ...
        pub fn set_fill_mode(&mut self, mode: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ProgressBar" , "set_fill_mode" , 1286410249i64);
        ...
        pub fn get_fill_mode(&mut self) -> i64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ProgressBar" , "get_fill_mode" , 2455072627i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_show_percentage(&mut self, visible: bool) {
            unsafe {
                let __class_name = StringName::from("ProgressBar");
                let __method_name = StringName::from("set_show_percentage");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ProgressBar" , "set_show_percentage" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn is_percentage_shown(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("ProgressBar");
                let __method_name = StringName::from("is_percentage_shown");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ProgressBar" , "is_percentage_shown" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
...
impl FillMode {
    pub const FILL_BEGIN_TO_END: Self = Self { ord: 0 };
    pub const FILL_END_TO_BEGIN: Self = Self { ord: 1 };
