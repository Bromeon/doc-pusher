...
pub(super) mod re_export {
    ...
    pub trait ShaderMaterialVirtual:
    ...
    impl ShaderMaterial {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ShaderMaterial");
                let __object_ptr =
        ...
        pub fn set_shader(&mut self, shader: Gd<Shader>) {
            unsafe {
                let __class_name = StringName::from("ShaderMaterial");
                let __method_name = StringName::from("set_shader");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3341921675i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ShaderMaterial" , "set_shader" , 3341921675i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<Gd<Shader> as AsArg>::as_arg_ptr(&shader)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        }
        pub fn get_shader(&self) -> Option<Gd<Shader>> {
            unsafe {
                let __class_name = StringName::from("ShaderMaterial");
                let __method_name = StringName::from("get_shader");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2078273437i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ShaderMaterial" , "get_shader" , 2078273437i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <Gd<Shader>>::from_sys_init_opt(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                })
            }
        }
        pub fn set_shader_parameter(&mut self, param: StringName, value: Variant) {
            unsafe {
                let __class_name = StringName::from("ShaderMaterial");
                let __method_name = StringName::from("set_shader_parameter");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3776071444i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ShaderMaterial" , "set_shader_parameter" , 3776071444i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <StringName as sys::GodotFfi>::sys_const(&param),
        ...
        pub fn get_shader_parameter(&self, param: StringName) -> Variant {
            unsafe {
                let __class_name = StringName::from("ShaderMaterial");
                let __method_name = StringName::from("get_shader_parameter");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2760726917i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ShaderMaterial" , "get_shader_parameter" , 2760726917i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<StringName as sys::GodotFfi>::sys_const(&param)];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for ShaderMaterial {
        ...
        const CLASS_NAME: &'static str = "ShaderMaterial";
    }
