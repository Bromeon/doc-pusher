...
pub(super) mod re_export {
    ...
    pub trait AudioEffectBandPassFilterVirtual:
    ...
    impl AudioEffectBandPassFilter {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("AudioEffectBandPassFilter");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for AudioEffectBandPassFilter {
        ...
        const CLASS_NAME: &'static str = "AudioEffectBandPassFilter";
    }
