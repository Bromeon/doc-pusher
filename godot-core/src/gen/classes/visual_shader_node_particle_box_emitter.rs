...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeParticleBoxEmitterVirtual:
    ...
    impl VisualShaderNodeParticleBoxEmitter {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeParticleBoxEmitter");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for VisualShaderNodeParticleBoxEmitter {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeParticleBoxEmitter";
    }
    ...
    impl crate::obj::Inherits<crate::engine::VisualShaderNodeParticleEmitter>
        for VisualShaderNodeParticleBoxEmitter
    {
    }
    ...
    macro_rules! inherits_transitive_VisualShaderNodeParticleBoxEmitter {
        ($ Class : ident) => {
            impl ::godot::obj::Inherits<::godot::engine::VisualShaderNodeParticleBoxEmitter>
                for $Class
            {
            }
