...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeVectorComposeVirtual:
    ...
    impl VisualShaderNodeVectorCompose {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeVectorCompose");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for VisualShaderNodeVectorCompose {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeVectorCompose";
    }
    ...
    impl crate::obj::Inherits<crate::engine::VisualShaderNodeVectorBase>
        for VisualShaderNodeVectorCompose
    {
    }
