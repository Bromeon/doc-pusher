...
pub(super) mod re_export {
    ...
    pub trait PlaceholderTextureLayeredVirtual:
    ...
    impl PlaceholderTextureLayered {
        ...
        pub fn set_size(&mut self, size: Vector2i) {
            unsafe {
                let __class_name = StringName::from("PlaceholderTextureLayered");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PlaceholderTextureLayered" , "set_size" , 1130785943i64);
        ...
        pub fn get_size(&self) -> Vector2i {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PlaceholderTextureLayered" , "get_size" , 3690982128i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_layers(&mut self, layers: i64) {
            unsafe {
                let __class_name = StringName::from("PlaceholderTextureLayered");
                let __method_name = StringName::from("set_layers");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1286410249i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "PlaceholderTextureLayered" , "set_layers" , 1286410249i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<i64 as sys::GodotFfi>::sys_const(&layers)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
    ...
    impl crate::obj::GodotClass for PlaceholderTextureLayered {
        ...
        const CLASS_NAME: &'static str = "PlaceholderTextureLayered";
    }
