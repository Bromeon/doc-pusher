...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeVec3ConstantVirtual:
    ...
    impl VisualShaderNodeVec3Constant {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeVec3Constant");
                let __object_ptr =
        ...
        pub fn set_constant(&mut self, constant: Vector3) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeVec3Constant" , "set_constant" , 3460891852i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<Vector3 as sys::GodotFfi>::sys_const(&constant)];
        ...
        pub fn get_constant(&self) -> Vector3 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeVec3Constant" , "get_constant" , 3360562783i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for VisualShaderNodeVec3Constant {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeVec3Constant";
    }
    ...
    impl crate::obj::Inherits<crate::engine::VisualShaderNodeConstant>
        for VisualShaderNodeVec3Constant
    {
    }
