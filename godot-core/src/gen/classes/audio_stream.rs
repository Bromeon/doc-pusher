...
pub(super) mod re_export {
    ...
    impl AudioStream {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("AudioStream");
                let __object_ptr =
        ...
        pub fn get_length(&self) -> f64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AudioStream" , "get_length" , 1740695150i64);
        ...
        pub fn is_monophonic(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("AudioStream");
                let __method_name = StringName::from("is_monophonic");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AudioStream" , "is_monophonic" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn instantiate_playback(&mut self) -> Option<Gd<AudioStreamPlayback>> {
            unsafe {
                let __class_name = StringName::from("AudioStream");
                let __method_name = StringName::from("instantiate_playback");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    210135309i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "AudioStream" , "instantiate_playback" , 210135309i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <Gd<AudioStreamPlayback>>::from_sys_init_opt(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                })
            }
        }
    ...
    impl crate::obj::GodotClass for AudioStream {
        ...
        const CLASS_NAME: &'static str = "AudioStream";
    }
