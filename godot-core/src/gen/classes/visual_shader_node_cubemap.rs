...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeCubemapVirtual:
    ...
    impl VisualShaderNodeCubemap {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeCubemap");
                let __object_ptr =
        ...
        pub fn set_source(&mut self, value: visual_shader_node_cubemap::Source) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeCubemap");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeCubemap" , "set_source" , 1625400621i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args =
                    [<visual_shader_node_cubemap::Source as sys::GodotFfi>::sys_const(&value)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        }
        pub fn get_source(&self) -> visual_shader_node_cubemap::Source {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeCubemap");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeCubemap" , "get_source" , 2222048781i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <visual_shader_node_cubemap::Source as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
        ...
        pub fn set_cube_map(&mut self, value: Gd<Cubemap>) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeCubemap");
                let __method_name = StringName::from("set_cube_map");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2219800736i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeCubemap" , "set_cube_map" , 2219800736i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<Gd<Cubemap> as AsArg>::as_arg_ptr(&value)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        }
        pub fn get_cube_map(&self) -> Option<Gd<Cubemap>> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeCubemap");
                let __method_name = StringName::from("get_cube_map");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1772111058i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeCubemap" , "get_cube_map" , 1772111058i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <Gd<Cubemap>>::from_sys_init_opt(|return_ptr| {
                    __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                })
            }
        }
        pub fn set_texture_type(&mut self, value: visual_shader_node_cubemap::TextureType) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeCubemap");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeCubemap" , "set_texture_type" , 1899718876i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <visual_shader_node_cubemap::TextureType as sys::GodotFfi>::sys_const(&value),
                ];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
        ...
        pub fn get_texture_type(&self) -> visual_shader_node_cubemap::TextureType {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeCubemap");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeCubemap" , "get_texture_type" , 3356498888i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <visual_shader_node_cubemap::TextureType as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
    ...
    impl crate::obj::GodotClass for VisualShaderNodeCubemap {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeCubemap";
    }
