...
pub(super) mod re_export {
    ...
    impl FogVolume {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("FogVolume");
                let __object_ptr =
        ...
        pub fn set_size(&mut self, size: Vector3) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "FogVolume" , "set_size" , 3460891852i64);
        ...
        pub fn get_size(&self) -> Vector3 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "FogVolume" , "get_size" , 3360562783i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_shape(&mut self, shape: rendering_server::FogVolumeShape) {
            unsafe {
                let __class_name = StringName::from("FogVolume");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "FogVolume" , "set_shape" , 1416323362i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args =
        ...
        pub fn get_shape(&self) -> rendering_server::FogVolumeShape {
            unsafe {
                let __class_name = StringName::from("FogVolume");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "FogVolume" , "get_shape" , 3920334604i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <rendering_server::FogVolumeShape as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
        ...
        pub fn set_material(&mut self, material: Gd<Material>) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "FogVolume" , "set_material" , 2757459619i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_material(&self) -> Option<Gd<Material>> {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "FogVolume" , "get_material" , 5934680i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for FogVolume {
        ...
        const CLASS_NAME: &'static str = "FogVolume";
    }
