...
pub(super) mod re_export {
    ...
    impl XrNode3D {
        ...
        pub fn set_tracker(&mut self, tracker_name: StringName) {
            unsafe {
                let __class_name = StringName::from("XRNode3D");
                let __method_name = StringName::from("set_tracker");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3304788590i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "XRNode3D" , "set_tracker" , 3304788590i64);
        ...
        pub fn get_tracker(&self) -> StringName {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "XRNode3D" , "get_tracker" , 2002593661i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_pose_name(&mut self, pose: StringName) {
            unsafe {
                let __class_name = StringName::from("XRNode3D");
                let __method_name = StringName::from("set_pose_name");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3304788590i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "XRNode3D" , "set_pose_name" , 3304788590i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<StringName as sys::GodotFfi>::sys_const(&pose)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        ...
        pub fn get_pose_name(&self) -> StringName {
            unsafe {
                let __class_name = StringName::from("XRNode3D");
                let __method_name = StringName::from("get_pose_name");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2002593661i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "XRNode3D" , "get_pose_name" , 2002593661i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <StringName as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn get_is_active(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("XRNode3D");
                let __method_name = StringName::from("get_is_active");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "XRNode3D" , "get_is_active" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn get_has_tracking_data(&self) -> bool {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "XRNode3D" , "get_has_tracking_data" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <bool as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn get_pose(&mut self) -> Option<Gd<XrPose>> {
            unsafe {
                let __class_name = StringName::from("XRNode3D");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "XRNode3D" , "get_pose" , 2806551826i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn trigger_haptic_pulse(
            ...
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "XRNode3D" , "trigger_haptic_pulse" , 508576839i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
    ...
    impl crate::obj::GodotClass for XrNode3D {
        ...
        const CLASS_NAME: &'static str = "XRNode3D";
    }
