...
pub(super) mod re_export {
    ...
    pub trait InputEventScreenTouchVirtual:
    ...
    impl InputEventScreenTouch {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("InputEventScreenTouch");
                let __object_ptr =
        ...
        pub fn set_index(&mut self, index: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventScreenTouch" , "set_index" , 1286410249i64);
        ...
        pub fn get_index(&self) -> i64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventScreenTouch" , "get_index" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_position(&mut self, position: Vector2) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventScreenTouch" , "set_position" , 743155724i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_position(&self) -> Vector2 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventScreenTouch" , "get_position" , 3341600327i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_pressed(&mut self, pressed: bool) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventScreenTouch" , "set_pressed" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn set_double_tap(&mut self, double_tap: bool) {
            unsafe {
                let __class_name = StringName::from("InputEventScreenTouch");
                let __method_name = StringName::from("set_double_tap");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventScreenTouch" , "set_double_tap" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<bool as sys::GodotFfi>::sys_const(&double_tap)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        ...
        pub fn is_double_tap(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("InputEventScreenTouch");
                let __method_name = StringName::from("is_double_tap");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventScreenTouch" , "is_double_tap" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for InputEventScreenTouch {
        ...
        const CLASS_NAME: &'static str = "InputEventScreenTouch";
    }
