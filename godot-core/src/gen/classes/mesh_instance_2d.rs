...
pub(super) mod re_export {
    ...
    pub trait MeshInstance2DVirtual:
    ...
    impl MeshInstance2D {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("MeshInstance2D");
                let __object_ptr =
        ...
        pub fn set_mesh(&mut self, mesh: Gd<Mesh>) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "MeshInstance2D" , "set_mesh" , 194775623i64);
        ...
        pub fn get_mesh(&self) -> Option<Gd<Mesh>> {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "MeshInstance2D" , "get_mesh" , 1808005922i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_texture(&mut self, texture: Gd<Texture2D>) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "MeshInstance2D" , "set_texture" , 4051416890i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_texture(&self) -> Option<Gd<Texture2D>> {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "MeshInstance2D" , "get_texture" , 3635182373i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for MeshInstance2D {
        ...
        const CLASS_NAME: &'static str = "MeshInstance2D";
    }
