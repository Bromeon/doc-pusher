...
pub(super) mod re_export {
    ...
    pub trait VideoStreamTheoraVirtual:
    ...
    impl VideoStreamTheora {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VideoStreamTheora");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for VideoStreamTheora {
        ...
        const CLASS_NAME: &'static str = "VideoStreamTheora";
    }
