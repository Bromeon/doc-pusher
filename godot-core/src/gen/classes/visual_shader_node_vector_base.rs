...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeVectorBaseVirtual:
    ...
    impl VisualShaderNodeVectorBase {
        ...
        pub fn set_op_type(&mut self, type_: visual_shader_node_vector_base::OpType) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeVectorBase");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeVectorBase" , "set_op_type" , 1692596998i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <visual_shader_node_vector_base::OpType as sys::GodotFfi>::sys_const(&type_),
                ];
        ...
        pub fn get_op_type(&self) -> visual_shader_node_vector_base::OpType {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeVectorBase");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeVectorBase" , "get_op_type" , 2568738462i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <visual_shader_node_vector_base::OpType as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
    ...
    impl crate::obj::GodotClass for VisualShaderNodeVectorBase {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeVectorBase";
    }
...
impl OpType {
    pub const OP_TYPE_VECTOR_2D: Self = Self { ord: 0 };
    pub const OP_TYPE_VECTOR_3D: Self = Self { ord: 1 };
    pub const OP_TYPE_VECTOR_4D: Self = Self { ord: 2 };
    pub const OP_TYPE_MAX: Self = Self { ord: 3 };
}
