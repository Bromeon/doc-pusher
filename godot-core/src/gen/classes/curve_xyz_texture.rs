...
pub(super) mod re_export {
    ...
    pub trait CurveXyzTextureVirtual:
    ...
    impl CurveXyzTexture {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("CurveXYZTexture");
                let __object_ptr =
        ...
        pub fn set_width(&mut self, width: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveXYZTexture" , "set_width" , 1286410249i64);
        ...
        pub fn set_curve_x(&mut self, curve: Gd<Curve>) {
            unsafe {
                let __class_name = StringName::from("CurveXYZTexture");
                let __method_name = StringName::from("set_curve_x");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    270443179i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveXYZTexture" , "set_curve_x" , 270443179i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_curve_x(&self) -> Option<Gd<Curve>> {
            unsafe {
                let __class_name = StringName::from("CurveXYZTexture");
                let __method_name = StringName::from("get_curve_x");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2460114913i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveXYZTexture" , "get_curve_x" , 2460114913i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_curve_y(&mut self, curve: Gd<Curve>) {
            unsafe {
                let __class_name = StringName::from("CurveXYZTexture");
                let __method_name = StringName::from("set_curve_y");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    270443179i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveXYZTexture" , "set_curve_y" , 270443179i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<Gd<Curve> as AsArg>::as_arg_ptr(&curve)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
        ...
        pub fn get_curve_y(&self) -> Option<Gd<Curve>> {
            unsafe {
                let __class_name = StringName::from("CurveXYZTexture");
                let __method_name = StringName::from("get_curve_y");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2460114913i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveXYZTexture" , "get_curve_y" , 2460114913i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <Gd<Curve>>::from_sys_init_opt(|return_ptr| {
        ...
        pub fn set_curve_z(&mut self, curve: Gd<Curve>) {
            unsafe {
                let __class_name = StringName::from("CurveXYZTexture");
                let __method_name = StringName::from("set_curve_z");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    270443179i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveXYZTexture" , "set_curve_z" , 270443179i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<Gd<Curve> as AsArg>::as_arg_ptr(&curve)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
        ...
        pub fn get_curve_z(&self) -> Option<Gd<Curve>> {
            unsafe {
                let __class_name = StringName::from("CurveXYZTexture");
                let __method_name = StringName::from("get_curve_z");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2460114913i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CurveXYZTexture" , "get_curve_z" , 2460114913i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <Gd<Curve>>::from_sys_init_opt(|return_ptr| {
    ...
    impl crate::obj::GodotClass for CurveXyzTexture {
        ...
        const CLASS_NAME: &'static str = "CurveXYZTexture";
    }
