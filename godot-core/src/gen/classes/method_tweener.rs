...
pub(super) mod re_export {
    ...
    pub trait MethodTweenerVirtual:
    ...
    impl MethodTweener {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("MethodTweener");
                let __object_ptr =
        ...
        pub fn set_delay(&mut self, delay: f64) -> Option<Gd<MethodTweener>> {
            unsafe {
                let __class_name = StringName::from("MethodTweener");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "MethodTweener" , "set_delay" , 266477812i64);
        ...
        pub fn set_trans(&mut self, trans: tween::TransitionType) -> Option<Gd<MethodTweener>> {
            unsafe {
                let __class_name = StringName::from("MethodTweener");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "MethodTweener" , "set_trans" , 3740975367i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn set_ease(&mut self, ease: tween::EaseType) -> Option<Gd<MethodTweener>> {
            unsafe {
                let __class_name = StringName::from("MethodTweener");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "MethodTweener" , "set_ease" , 315540545i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
    ...
    impl crate::obj::GodotClass for MethodTweener {
        ...
        const CLASS_NAME: &'static str = "MethodTweener";
    }
