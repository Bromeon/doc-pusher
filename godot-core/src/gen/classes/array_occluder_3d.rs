...
pub(super) mod re_export {
    ...
    pub trait ArrayOccluder3DVirtual:
    ...
    impl ArrayOccluder3D {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ArrayOccluder3D");
                let __object_ptr =
        ...
        pub fn set_arrays(&mut self, vertices: PackedVector3Array, indices: PackedInt32Array) {
            unsafe {
                let __class_name = StringName::from("ArrayOccluder3D");
                let __method_name = StringName::from("set_arrays");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3233972621i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ArrayOccluder3D" , "set_arrays" , 3233972621i64);
        ...
        pub fn set_vertices(&mut self, vertices: PackedVector3Array) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ArrayOccluder3D" , "set_vertices" , 334873810i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn set_indices(&mut self, indices: PackedInt32Array) {
            unsafe {
                let __class_name = StringName::from("ArrayOccluder3D");
                let __method_name = StringName::from("set_indices");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3614634198i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ArrayOccluder3D" , "set_indices" , 3614634198i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<PackedInt32Array as sys::GodotFfi>::sys_const(&indices)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
    ...
    impl crate::obj::GodotClass for ArrayOccluder3D {
        ...
        const CLASS_NAME: &'static str = "ArrayOccluder3D";
    }
