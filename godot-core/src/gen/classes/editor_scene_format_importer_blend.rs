...
pub(super) mod re_export {
    ...
    pub trait EditorSceneFormatImporterBlendVirtual:
    ...
    impl crate::obj::GodotClass for EditorSceneFormatImporterBlend {
        ...
        const CLASS_NAME: &'static str = "EditorSceneFormatImporterBlend";
    }
    ...
    impl crate::obj::Inherits<crate::engine::EditorSceneFormatImporter>
        for EditorSceneFormatImporterBlend
    {
    }
    ...
    macro_rules! inherits_transitive_EditorSceneFormatImporterBlend {
        ($ Class : ident) => {
            impl ::godot::obj::Inherits<::godot::engine::EditorSceneFormatImporterBlend>
                for $Class
            {
            }
