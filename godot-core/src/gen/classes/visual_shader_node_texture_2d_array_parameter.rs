...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeTexture2DArrayParameterVirtual:
    ...
    impl VisualShaderNodeTexture2DArrayParameter {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeTexture2DArrayParameter");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for VisualShaderNodeTexture2DArrayParameter {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeTexture2DArrayParameter";
    }
    ...
    impl crate::obj::Inherits<crate::engine::VisualShaderNodeTextureParameter>
        for VisualShaderNodeTexture2DArrayParameter
    {
    }
    ...
    macro_rules! inherits_transitive_VisualShaderNodeTexture2DArrayParameter {
        ($ Class : ident) => {
            impl ::godot::obj::Inherits<::godot::engine::VisualShaderNodeTexture2DArrayParameter>
                for $Class
            {
            }
