...
pub(super) mod re_export {
    ...
    pub trait CsgPrimitive3DVirtual:
    ...
    impl CsgPrimitive3D {
        ...
        pub fn set_flip_faces(&mut self, flip_faces: bool) {
            unsafe {
                let __class_name = StringName::from("CSGPrimitive3D");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGPrimitive3D" , "set_flip_faces" , 2586408642i64);
        ...
        pub fn get_flip_faces(&mut self) -> bool {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGPrimitive3D" , "get_flip_faces" , 2240911060i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for CsgPrimitive3D {
        ...
        const CLASS_NAME: &'static str = "CSGPrimitive3D";
    }
