...
pub(super) mod re_export {
    ...
    pub trait ScriptEditorBaseVirtual:
    ...
    impl ScriptEditorBase {
        ...
        pub fn get_base_editor(&self) -> Option<Gd<Control>> {
            unsafe {
                let __class_name = StringName::from("ScriptEditorBase");
                let __method_name = StringName::from("get_base_editor");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2783021301i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ScriptEditorBase" , "get_base_editor" , 2783021301i64);
        ...
        pub fn add_syntax_highlighter(&mut self, highlighter: Gd<EditorSyntaxHighlighter>) {
            unsafe {
                let __class_name = StringName::from("ScriptEditorBase");
                let __method_name = StringName::from("add_syntax_highlighter");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1092774468i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ScriptEditorBase" , "add_syntax_highlighter" , 1092774468i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<Gd<EditorSyntaxHighlighter> as AsArg>::as_arg_ptr(
                    &highlighter,
                )];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for ScriptEditorBase {
        ...
        const CLASS_NAME: &'static str = "ScriptEditorBase";
    }
