...
pub(super) mod re_export {
    ...
    pub trait ReferenceRectVirtual:
    ...
    impl ReferenceRect {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("ReferenceRect");
                let __object_ptr =
        ...
        pub fn get_border_color(&self) -> Color {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ReferenceRect" , "get_border_color" , 3444240500i64);
        ...
        pub fn set_border_color(&mut self, color: Color) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ReferenceRect" , "set_border_color" , 2920490490i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_border_width(&self) -> f64 {
            unsafe {
                let __class_name = StringName::from("ReferenceRect");
                let __method_name = StringName::from("get_border_width");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1740695150i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ReferenceRect" , "get_border_width" , 1740695150i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_border_width(&mut self, width: f64) {
            unsafe {
                let __class_name = StringName::from("ReferenceRect");
                let __method_name = StringName::from("set_border_width");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    373806689i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ReferenceRect" , "set_border_width" , 373806689i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<f64 as sys::GodotFfi>::sys_const(&width)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        ...
        pub fn get_editor_only(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("ReferenceRect");
                let __method_name = StringName::from("get_editor_only");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ReferenceRect" , "get_editor_only" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_editor_only(&mut self, enabled: bool) {
            unsafe {
                let __class_name = StringName::from("ReferenceRect");
                let __method_name = StringName::from("set_editor_only");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "ReferenceRect" , "set_editor_only" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
    ...
    impl crate::obj::GodotClass for ReferenceRect {
        ...
        const CLASS_NAME: &'static str = "ReferenceRect";
    }
