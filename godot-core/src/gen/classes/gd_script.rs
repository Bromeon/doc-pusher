...
pub(super) mod re_export {
    ...
    impl GdScript {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("GDScript");
                let __object_ptr =
        ...
        pub fn instantiate(&mut self, varargs: &[Variant]) -> Variant {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "GDScript" , "instantiate" , 1545262638i64);
                ...
                let variant = Variant::from_var_sys_init(|return_ptr| {
                    ...
                    if __err.error != sys::GDEXTENSION_CALL_OK {
                        ...
                        sys::panic_call_error(
                            &__err,
                            &format!("instantiate(; {__vararg_str})"),
                            &__arg_types,
                        );
                    }
                });
    ...
    impl crate::obj::GodotClass for GdScript {
        ...
        const CLASS_NAME: &'static str = "GDScript";
    }
    impl crate::obj::EngineClass for GdScript {
    ...
    impl crate::obj::Inherits<crate::engine::Script> for GdScript {}
    impl crate::obj::Inherits<crate::engine::Resource> for GdScript {}
    impl crate::obj::Inherits<crate::engine::RefCounted> for GdScript {}
    impl crate::obj::Inherits<crate::engine::Object> for GdScript {}
    ...
    macro_rules! inherits_transitive_GdScript {
        ($ Class : ident) => {
            impl ::godot::obj::Inherits<::godot::engine::GdScript> for $Class {}
