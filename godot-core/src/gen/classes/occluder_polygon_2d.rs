...
pub(super) mod re_export {
    ...
    pub trait OccluderPolygon2DVirtual:
    ...
    impl OccluderPolygon2D {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("OccluderPolygon2D");
                let __object_ptr =
        ...
        pub fn set_closed(&mut self, closed: bool) {
            unsafe {
                let __class_name = StringName::from("OccluderPolygon2D");
                let __method_name = StringName::from("set_closed");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    2586408642i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "OccluderPolygon2D" , "set_closed" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<bool as sys::GodotFfi>::sys_const(&closed)];
        ...
        pub fn is_closed(&self) -> bool {
            unsafe {
                let __class_name = StringName::from("OccluderPolygon2D");
                let __method_name = StringName::from("is_closed");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    36873697i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "OccluderPolygon2D" , "is_closed" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_cull_mode(&mut self, cull_mode: occluder_polygon_2d::CullMode) {
            unsafe {
                let __class_name = StringName::from("OccluderPolygon2D");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "OccluderPolygon2D" , "set_cull_mode" , 3500863002i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<occluder_polygon_2d::CullMode as sys::GodotFfi>::sys_const(
                    &cull_mode,
                )];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
        ...
        pub fn get_cull_mode(&self) -> occluder_polygon_2d::CullMode {
            unsafe {
                let __class_name = StringName::from("OccluderPolygon2D");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "OccluderPolygon2D" , "get_cull_mode" , 33931036i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <occluder_polygon_2d::CullMode as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
        ...
        pub fn set_polygon(&mut self, polygon: PackedVector2Array) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "OccluderPolygon2D" , "set_polygon" , 1509147220i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_polygon(&self) -> PackedVector2Array {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "OccluderPolygon2D" , "get_polygon" , 2961356807i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for OccluderPolygon2D {
        ...
        const CLASS_NAME: &'static str = "OccluderPolygon2D";
    }
...
impl CullMode {
    pub const CULL_DISABLED: Self = Self { ord: 0 };
    pub const CULL_CLOCKWISE: Self = Self { ord: 1 };
    pub const CULL_COUNTER_CLOCKWISE: Self = Self { ord: 2 };
}
