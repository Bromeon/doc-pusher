...
pub(super) mod re_export {
    ...
    pub trait InputEventShortcutVirtual:
    ...
    impl InputEventShortcut {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("InputEventShortcut");
                let __object_ptr =
        ...
        pub fn set_shortcut(&mut self, shortcut: Gd<Shortcut>) {
            unsafe {
                let __class_name = StringName::from("InputEventShortcut");
                let __method_name = StringName::from("set_shortcut");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    857163497i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventShortcut" , "set_shortcut" , 857163497i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [<Gd<Shortcut> as AsArg>::as_arg_ptr(&shortcut)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        }
        pub fn get_shortcut(&mut self) -> Option<Gd<Shortcut>> {
            unsafe {
                let __class_name = StringName::from("InputEventShortcut");
                let __method_name = StringName::from("get_shortcut");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    3766804753i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "InputEventShortcut" , "get_shortcut" , 3766804753i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for InputEventShortcut {
        ...
        const CLASS_NAME: &'static str = "InputEventShortcut";
    }
