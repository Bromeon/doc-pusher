...
pub(super) mod re_export {
    ...
    pub trait VisualShaderNodeSwitchVirtual:
    ...
    impl VisualShaderNodeSwitch {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeSwitch");
                let __object_ptr =
        ...
        pub fn set_op_type(&mut self, type_: visual_shader_node_switch::OpType) {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeSwitch");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeSwitch" , "set_op_type" , 510471861i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args =
                    [<visual_shader_node_switch::OpType as sys::GodotFfi>::sys_const(&type_)];
                let __args_ptr = __args.as_ptr();
                let return_ptr = std::ptr::null_mut();
                __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
            }
        }
        pub fn get_op_type(&self) -> visual_shader_node_switch::OpType {
            unsafe {
                let __class_name = StringName::from("VisualShaderNodeSwitch");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisualShaderNodeSwitch" , "get_op_type" , 2517845071i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <visual_shader_node_switch::OpType as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
    ...
    impl crate::obj::GodotClass for VisualShaderNodeSwitch {
        ...
        const CLASS_NAME: &'static str = "VisualShaderNodeSwitch";
    }
...
impl OpType {
    ...
    pub const OP_TYPE_BOOLEAN: Self = Self { ord: 6 };
    pub const OP_TYPE_TRANSFORM: Self = Self { ord: 7 };
    pub const OP_TYPE_MAX: Self = Self { ord: 8 };
}
