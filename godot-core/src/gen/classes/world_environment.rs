...
pub(super) mod re_export {
    ...
    pub trait WorldEnvironmentVirtual:
    ...
    impl WorldEnvironment {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("WorldEnvironment");
                let __object_ptr =
        ...
        pub fn set_environment(&mut self, env: Gd<Environment>) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "WorldEnvironment" , "set_environment" , 4143518816i64);
        ...
        pub fn get_environment(&self) -> Option<Gd<Environment>> {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "WorldEnvironment" , "get_environment" , 3082064660i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_camera_attributes(&mut self, camera_attributes: Gd<CameraAttributes>) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "WorldEnvironment" , "set_camera_attributes" , 2817810567i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_camera_attributes(&self) -> Option<Gd<CameraAttributes>> {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "WorldEnvironment" , "get_camera_attributes" , 3921283215i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for WorldEnvironment {
        ...
        const CLASS_NAME: &'static str = "WorldEnvironment";
    }
