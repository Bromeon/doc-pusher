...
pub(super) mod re_export {
    ...
    pub trait DirectionalLight2DVirtual:
    ...
    impl DirectionalLight2D {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("DirectionalLight2D");
                let __object_ptr =
        ...
        pub fn set_max_distance(&mut self, pixels: f64) {
            unsafe {
                let __class_name = StringName::from("DirectionalLight2D");
                let __method_name = StringName::from("set_max_distance");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    373806689i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "DirectionalLight2D" , "set_max_distance" , 373806689i64);
        ...
        pub fn get_max_distance(&self) -> f64 {
            unsafe {
                let __class_name = StringName::from("DirectionalLight2D");
                let __method_name = StringName::from("get_max_distance");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    1740695150i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "DirectionalLight2D" , "get_max_distance" , 1740695150i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for DirectionalLight2D {
        ...
        const CLASS_NAME: &'static str = "DirectionalLight2D";
    }
