...
pub(super) mod re_export {
    ...
    pub trait VisibleOnScreenEnabler3DVirtual:
    ...
    impl VisibleOnScreenEnabler3D {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VisibleOnScreenEnabler3D");
                let __object_ptr =
        ...
        pub fn set_enable_mode(&mut self, mode: visible_on_screen_enabler_3d::EnableMode) {
            unsafe {
                let __class_name = StringName::from("VisibleOnScreenEnabler3D");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisibleOnScreenEnabler3D" , "set_enable_mode" , 320303646i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [
                    <visible_on_screen_enabler_3d::EnableMode as sys::GodotFfi>::sys_const(&mode),
                ];
        ...
        pub fn get_enable_mode(&mut self) -> visible_on_screen_enabler_3d::EnableMode {
            unsafe {
                let __class_name = StringName::from("VisibleOnScreenEnabler3D");
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisibleOnScreenEnabler3D" , "get_enable_mode" , 3352990031i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <visible_on_screen_enabler_3d::EnableMode as sys::GodotFfi>::from_sys_init_default(
                    |return_ptr| {
                        __call_fn(__method_bind, self.object_ptr, __args_ptr, return_ptr);
                    },
                )
        ...
        pub fn set_enable_node_path(&mut self, path: NodePath) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisibleOnScreenEnabler3D" , "set_enable_node_path" , 1348162250i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_enable_node_path(&mut self) -> NodePath {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VisibleOnScreenEnabler3D" , "get_enable_node_path" , 277076166i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for VisibleOnScreenEnabler3D {
        ...
        const CLASS_NAME: &'static str = "VisibleOnScreenEnabler3D";
    }
