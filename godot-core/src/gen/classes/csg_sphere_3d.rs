...
pub(super) mod re_export {
    ...
    impl CsgSphere3D {
        ...
        pub fn new_alloc() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("CSGSphere3D");
                let __object_ptr =
        ...
        pub fn set_radius(&mut self, radius: f64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGSphere3D" , "set_radius" , 373806689i64);
        ...
        pub fn get_radius(&self) -> f64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGSphere3D" , "get_radius" , 1740695150i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_radial_segments(&mut self, radial_segments: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGSphere3D" , "set_radial_segments" , 1286410249i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_radial_segments(&self) -> i64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGSphere3D" , "get_radial_segments" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_rings(&mut self, rings: i64) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGSphere3D" , "set_rings" , 1286410249i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_rings(&self) -> i64 {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGSphere3D" , "get_rings" , 3905245786i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
                <i64 as sys::GodotFfi>::from_sys_init_default(|return_ptr| {
        ...
        pub fn set_smooth_faces(&mut self, smooth_faces: bool) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGSphere3D" , "set_smooth_faces" , 2586408642i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_smooth_faces(&self) -> bool {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGSphere3D" , "get_smooth_faces" , 36873697i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
        ...
        pub fn set_material(&mut self, material: Gd<Material>) {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGSphere3D" , "set_material" , 2757459619i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
        ...
        pub fn get_material(&self) -> Option<Gd<Material>> {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "CSGSphere3D" , "get_material" , 5934680i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for CsgSphere3D {
        ...
        const CLASS_NAME: &'static str = "CSGSphere3D";
    }
