...
pub(super) mod re_export {
    ...
    impl VideoStream {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("VideoStream");
                let __object_ptr =
        ...
        pub fn set_file(&mut self, file: GodotString) {
            unsafe {
                let __class_name = StringName::from("VideoStream");
                let __method_name = StringName::from("set_file");
                let __method_bind = sys::interface_fn!(classdb_get_method_bind)(
                    __class_name.string_sys(),
                    __method_name.string_sys(),
                    83702148i64,
                );
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VideoStream" , "set_file" , 83702148i64);
        ...
        pub fn get_file(&mut self) -> GodotString {
            unsafe {
                ...
                assert ! (! __method_bind . is_null () , "failed to load method {}::{} (hash {}) -- possible Godot/gdext version mismatch" , "VideoStream" , "get_file" , 2841200299i64);
                let __call_fn = sys::interface_fn!(object_method_bind_ptrcall);
                let __args = [];
                let __args_ptr = __args.as_ptr();
    ...
    impl crate::obj::GodotClass for VideoStream {
        ...
        const CLASS_NAME: &'static str = "VideoStream";
    }
