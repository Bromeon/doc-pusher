...
pub(super) mod re_export {
    ...
    pub trait GltfDocumentExtensionConvertImporterMeshVirtual:
    ...
    impl GltfDocumentExtensionConvertImporterMesh {
        pub fn new() -> Gd<Self> {
            unsafe {
                let __class_name = StringName::from("GLTFDocumentExtensionConvertImporterMesh");
                let __object_ptr =
    ...
    impl crate::obj::GodotClass for GltfDocumentExtensionConvertImporterMesh {
        ...
        const CLASS_NAME: &'static str = "GLTFDocumentExtensionConvertImporterMesh";
    }
    ...
    impl crate::obj::Inherits<crate::engine::GltfDocumentExtension>
        for GltfDocumentExtensionConvertImporterMesh
    {
    }
    ...
    macro_rules! inherits_transitive_GltfDocumentExtensionConvertImporterMesh {
        ($ Class : ident) => {
            impl ::godot::obj::Inherits<::godot::engine::GltfDocumentExtensionConvertImporterMesh>
                for $Class
            {
            }
